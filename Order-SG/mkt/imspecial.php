            ...
            <?
			   ...
			   $msg=$_GET['msg'];
                ...
                if($msg=='Error'){
                    ...
                    $qse="SELECT * FROM specialpricetmp WHERE StatusItem='E'";
					//echo $qse;
                ...
                if($msg=='Add'){
                    ...
                    $qa="SELECT Cusno, Itnbr, Price, CurCD, CUST2, CUST3 FROM specialpricetmp WHERE StatusItem !='H'";
                    ...
                    while($arrqa=mysqli_fetch_array($sqlqa)){
                        ...
                        $qi2="INSERT INTO specialprice(Cusno, Itnbr, Price, CurCD, CUST2, CUST3) VALUES('$acusno','$aitnbr','$aprice','$acurcd','$acust2','$acust3')";
                ...
                if($msg=='Replace'){
                    ...
                    $qu3="SELECT Cusno, Itnbr, Price, CurCD, CUST2, CUST3 FROM specialpricetmp WHERE StatusItem !='H'";
                ...
                if($msg=='Confirm'){
                    // Check count 
                    $qc1="SELECT COUNT(*) AS fcount FROM specialprice";
                    $sqlqc1=mysqli_query($msqlcon,$qc1);
                    $arqc1=mysqli_fetch_array($sqlqc1);
                    $fcount=$arqc1['fcount'];
                        
                    $qc2="SELECT COUNT(*) AS tmpcount FROM specialpricetmp WHERE StatusItem!='H'";
                    ...
                    <?
                        $qa2="SELECT Cusno, Itnbr, Price, CurCD, CUST2, CUST3 FROM specialpricetmp WHERE StatusItem!='H' LIMIT 10";
