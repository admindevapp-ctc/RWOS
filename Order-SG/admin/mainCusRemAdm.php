...
<script type="text/javascript">
  ...
  <tr class="arial11white" bgcolor="#AD1D36" >
	...
	$query="select * from  cusrem inner join cusmas on cusrem.cusno=cusmas.cusno and cusrem.Owner_Comp=cusmas.Owner_Comp where Cusrem.Cusno!='admin' and Cusrem.Owner_Comp='$comp'";
	...
	$query1="select * from  cusrem inner join cusmas on cusrem.cusno=cusmas.cusno and cusrem.Owner_Comp=cusmas.Owner_Comp where Cusrem.Cusno!='admin' and Cusrem.Owner_Comp='$comp' order by Cusrem.Cusno".		
	...
	$sql=mysqli_query($msqlcon,$query1);	
		...
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vowner."</td><td>".$vcusno."</td><td>".$vcusnm."</td><td>".$curcd."</td>" ;
			echo "<td>".$vremark."</td>";
