...
<html>
    <head>
        ...
        // CTC P.Pawan 04/03/19 Add dialog for send email -- start --
                $( "#dialog-sendMail" ).dialog({
                  ...
                  open: function(event, ui) {
            		...
            		});// CTC P.Pawan 04/03/19 Add dialog for send email -- end --
        //CTC P.Pawan 04/03/19 Add dialog messege -- start --
                $( "#dialog-message" ).dialog({
                  ...
                  close: function(){
            		...
            		});//CTC P.Pawan 04/03/19 Add dialog messege -- end --
            });

            function validateEmail(obj){//CTC P.Pawan 04/03/19 check input pattern email -- start --
            ...
            }//CTC P.Pawan 04/03/19 check input pattern email -- end --

            function sendEmail(orderNo,shipToCd,corNo,supNo,supNM){//CTC P.Pawan 04/03/19 prepare send email -- start --
              $(".axEmail").each(function(){
                this.value = "";
              });
              //alert(supNM);
            ...
            }//CTC P.Pawan 04/03/19 prepare send email -- end --
        ...
        <div id="twocolRight">
            <table width="97%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="arial11blackbold">
                    ...
                    <?
                        ...
                        FROM `suporderhdr` JOIN supmas on suporderhdr.supno = supmas.supno and suporderhdr.Owner_Comp = supmas.Owner_Comp
                        WHERE suporderhdr.Owner_Comp='$owner_comp' and suporderhdr.Cust3 ='" . $cusno . "' group by suporderhdr.Corno order by supmas.supno asc";
                        //echo $query;
                    ...
                    <?
                        ...
                        if ($supno != '' && $supno != null) {
                          $query = "select distinct Corno as ponumber from suporderhdr  where Cust3 ='" . $cusno . "' and supno='$supno' and Owner_Comp='$owner_comp' group by Corno order by orderdate desc";
                        } else {
                          $query = "select distinct Corno as ponumber from suporderhdr  where Cust3 ='" . $cusno . "' and Owner_Comp='$owner_comp'  group by Corno order by orderdate desc";
                        }
            ...
            <table width="100%" class="tbl1" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                <tr class="arial11white" bgcolor="#AD1D36" >
                    ...
                    <th width="10%" scope="col"><?php echo get_lng($_SESSION["lng"], "L0132"); ?><!--Denso Order Number--></th>
                    <th width="10%" scope="col"><?php echo get_lng($_SESSION["lng"], "L0133"); ?><!--Ship To--></th>
                ...
                if ($supno != '' && $supno != null) {
                    $query = "select *, (select supnm from supmas "
                      . " where supmas.Owner_Comp = suporderhdr.Owner_Comp AND suporderhdr.supno = supmas.supno ) as supname , supordernts.remark"
                      . " from suporderhdr "
                      . " inner join supordernts on suporderhdr.orderno=supordernts.orderno and suporderhdr.Owner_Comp=supordernts.Owner_Comp  and suporderhdr.Corno = supordernts.Corno  and suporderhdr.supno=supordernts.supno "
                      . " where suporderhdr.Trflg!='' and suporderhdr.Cust3 ='" . $cusno . "' and suporderhdr.supno='" .$supno. "' and suporderhdr.Owner_Comp='". $owner_comp ."' " 
                      . " group by suporderhdr.orderno,suporderhdr.supno order by suporderhdr.orderdate, suporderhdr.orderno, suporderhdr.supno desc";
                } else if ($ponum != '' && $ponum != null) {
                  $query = "select *, (select supnm from supmas "
                    . " where supmas.Owner_Comp = suporderhdr.Owner_Comp AND suporderhdr.supno = supmas.supno ) as supname , supordernts.remark "
                    . " from suporderhdr  "
                    . " inner join supordernts on suporderhdr.orderno=supordernts.orderno and suporderhdr.Owner_Comp=supordernts.Owner_Comp  and suporderhdr.Corno = supordernts.Corno  and suporderhdr.supno=supordernts.supno " 
                    . " where suporderhdr.Trflg!='' and suporderhdr.Cust3 ='" . $cusno . "' and suporderhdr.Owner_Comp='$owner_comp' and suporderhdr.Corno = '$ponum' group by suporderhdr.orderno,suporderhdr.supno order by  suporderhdr.orderdate, suporderhdr.orderno, suporderhdr.supno desc";
                }else {
                    $query = "select * , (select supnm from supmas where supmas.Owner_Comp = suporderhdr.Owner_Comp AND suporderhdr.supno = supmas.supno ) as supname , supordernts.remark "
                    ." from suporderhdr  "
                    . " inner join supordernts on suporderhdr.orderno=supordernts.orderno and suporderhdr.Owner_Comp=supordernts.Owner_Comp  and suporderhdr.Corno = supordernts.Corno  and suporderhdr.supno=supordernts.supno "
                    . " where suporderhdr.Trflg!='' and suporderhdr.Cust3 ='" . $cusno . "' and suporderhdr.Owner_Comp='$owner_comp' group by suporderhdr.orderno,suporderhdr.supno order by  suporderhdr.orderdate, suporderhdr.orderno, suporderhdr.supno desc";
                }
                //echo $query;
                ...
                while ($hasil = mysqli_fetch_array($sql)) {
                    ...
                    echo "</td >";
                      ...
                      $tmpEmail=[];
                      $emailcc = "";
                      $getemail = "select distinct st.* from `shiptoma` st,`suporderhdr` od 
