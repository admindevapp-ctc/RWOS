...
/* Database connection information */
	...
	$sQuery = "select suporderdtl.slsprice, qty , suporderhdr.supno, suporderhdr.CUST3,suporderhdr.cusno, partno, suporderhdr.orderno, itdsc, suporderhdr.Corno, suporderhdr.orderdate,DueDate, supordernts.remark ".
	...
	" where suporderhdr.orderdate>='$datefrom' and suporderhdr.orderdate<='$dateto' and suporderhdr.Owner_Comp='$owner_comp' and suporderhdr.cusno ='$cusno'" ;
...
*/
		...
		// $data= [$owner_comp,$,$,$,$,$,$vcust3,$supno,$remark];
		$data= [$corno,$orddate,$partno,$partdes,$duedt,number_format($qty),number_format($slsprice,2),number_format($slsamt,2),$supno,$remark];
