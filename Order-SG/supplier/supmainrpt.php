...
<table width="97%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="arial11blackbold">
    <td width="22%"><?php echo get_lng($_SESSION["lng"], "L0451"); //Supplier Number ?></td>
    <td width="2%">:</td>
    <td width="26%"><? echo $supno ?></td>
    <td width="4%"></td>
    <td width="20%"></td>
    <td width="2%"></td>
    <td width="25%"></td>
  ...
  <tr class="arial11blackbold">
	...
	<tbody>
        ...
        <tr align="right" valign="middle" height="50" >
