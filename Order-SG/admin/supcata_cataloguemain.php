        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                function UpdateSupplierList() {
                    $.ajax({
                        url: "cataloguemain/ctcGetSupplierAjax.php",
                        type: 'post',
                        data: {CarMaker: $('#cbocatmaker').val(), ModelName: $('#cbocatmodel').val()},
                        success: function (response) {
                            var decodeJson = JSON.parse(response);
                ...
                //$('#buttonSupSearch').on('click', function () {
                ...
                table = $('#tablecatalog').removeAttr('width').DataTable({
                    ...
                    'columnDefs': [
                        ...
                        {width: 70, targets: 4},//Model
                        {width: 80, targets: 5},//En
                        {width: 80, targets: 6},//Ge
                        {width: 80, targets: 7},//Sup
            ...
            <div class="col-md-12 margin-bottom-md" style="padding-right: 40px;">
                <div class="row">
                    <div class="col-md-3 arial21redbold">
                        <img src="../images/cata.png" width="17" height="15">&nbsp; <?php echo get_lng($_SESSION["lng"], "L0551")/* $lang['en']['L0551'] = "Supplier Part Catalogue";*/; ?>
                    </div>
                </div>
