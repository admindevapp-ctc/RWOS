	...
	<div id="isi">
		<div id="twocolRight1">
			<table width="97%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr class="arial11blackbold">
					<td width="22%"><?php echo get_lng($_SESSION["lng"], "L0482"); //Customer Number
									?></td>
					<td width="2%">:</td>
					<td width="26%"><? echo $cusno ?></td>
					<td width="4%"></td>
					<td width="20%"><?php echo get_lng($_SESSION["lng"], "L0460"); //Customer Name
									?></td>
					<td width="2%">:</td>
				...
				<tr class="arial11blackbold">
					<td><?php echo get_lng($_SESSION["lng"], "L0493"); //Order Date From 
						?></td>
					<td>:</td>
					<td>
				...
				<tr class="arial11blackbold">
					<td><?php echo get_lng($_SESSION["lng"], "L0494"); //Order Date To
						?></td>
					<td>:</td>
					<td>
						<table width="224" border="0">
			...
			<table border="0" cellspacing="0" cellpadding="0" align="" width="95%">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="tbl1" id="example" width="97%" style="table-layout: fixed;">
				<thead>
					<tr align="center" height="30">
						<th width="10%">
							<div id="Pono">
								<div class="PartAsc"><a href="#"><?php echo get_lng($_SESSION["lng"], "L0053"); //PO Number
																	?></a></div>
							</div>
						</th>
						<th width="10%">
							<div id="odrdate">
								<div class="PartAsc"><a href="#"><?php echo get_lng($_SESSION["lng"], "L0052"); //Order Date
																	?></a></div>
							</div>
						</th>
						<th width="10%">
							<div id="Partno">
								<div class="PartAsc"><a href="#"><?php echo get_lng($_SESSION["lng"], "L0144"); //Part Number
																	?></a></div>
							</div>
						</th>
						...
						<th width="10%"><?php echo get_lng($_SESSION["lng"], "L0492"); //Due Date
							?></th>
						<th width="5%"><?php echo get_lng($_SESSION["lng"], "L0557");  //QTY
							?></th>
						<th width="10%"><?php echo get_lng($_SESSION["lng"], "L0524");//Price
							?></th>
				...
				<tbody>
					<tr>
						<td colspan="10" id="result1"></td>
					</tr>

					<tr align="right" valign="middle" height="30">
						<td colspan="10" class="lastpg">
