    ...
    <div id="isi">
        ...
        <div id="twocolRight1">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="tbl1" id="example" width="97%">
                <thead>
                    ...
                    <tr align="center" height="30">
                        ...
                        <th width="13%"><?php echo get_lng($_SESSION["lng"], "L0216"); ?>
                            <!--Part Name-->
                        </th>
                        <th width="8%"><?php echo get_lng($_SESSION["lng"], "L0220"); ?>
                            <!--Due Date-->
                        </th>
                        <th width="3%"><?php echo get_lng($_SESSION["lng"], "L0221"); ?>
                            <!--Qty-->
                        </th>
                        <th width="8%"><?php echo get_lng($_SESSION["lng"], "L0524"); ?>
                            <!--price-->
                        </th>
                        <th width="8%"><?php echo get_lng($_SESSION["lng"], "L0411"); ?>
                            <!--Amount-->
                        </th>
                        <th width="8%"><?php echo get_lng($_SESSION["lng"], "L0556"); ?>
                            <!--Ship Date -->
                        </th>
                        <th width="8%"><?php echo get_lng($_SESSION["lng"], "L0557"); ?>
                            <!--Ship Qty -->
                        </th>
                        <th width="8%"><?php echo get_lng($_SESSION["lng"], "L0558"); ?>
                            <!--Invoice No -->
                        </th>
                        <th width="8%" class="lastth"><?php echo get_lng($_SESSION["lng"], "L0559"); ?>
                            <!--Status -->
                        </th>
                        <!-- <th width="9%" class="lastth">User</th>-->
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <div id="dialog-form" title="<?php echo get_lng($_SESSION["lng"], "L0213");/*Search*/ ?>" style="display: none;">
                <p class="validateTips"><?php echo get_lng($_SESSION["lng"], "L0106"); ?>
                    <!--Search Option-->
                </p>
