...
{       
	...
	$criteria =  " where awscusmas.Owner_Comp = '$owner_comp'";
...
$datas[0] = $header;
	...
	while ( $hasil = mysqli_fetch_array( $rResult ) )
	{
	    ...
	    $data= [$vowner,$vcusno2,$vshpto2,$vcusnm2,$vcusgrp,$vshpaddr1,$vshpaddr2,$vshpaddr3,$vmail1,$vmail2,$vmail3];
...
$xlsx->downloadAs('2ndCustomer group MA.xlsx');
