...
if(isset($_POST['submit'])){
    ...
    if($flagpro=='upcsv'){
        ...
        $qs2="SELECT Cusno,Itnbr FROM specialpriceawstmp WHERE StatusItem != 'H'";
        ...
        while($arr2=mysqli_fetch_array($sqlqs2)){
            ...
            $qs3="SELECT Cusno,Itnbr FROM specialpriceaws WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
            ...
            if(!$arr3){
                if($radvalact=='add'){
                    ...
                    $qu1="UPDATE specialpriceawstmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
                ...
                if($radvalact=='edit'){
                    ...
                    $qu2="UPDATE specialpriceawstmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
