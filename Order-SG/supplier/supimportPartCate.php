	...
	<body >
		...
		<table width="97%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="arial11blackbold">
                ...
                <td colspan="5" class="arial21redbold"><?php echo get_lng($_SESSION["lng"], "M007"); // //Catalogue Maintenance ?>  </td>
            ...
            <tr class="arial11blackbold">
             ...
             <form method="POST" enctype="multipart/form-data" name="uploadForm" action='Property/uploadcatalogue.php' id='frmimport'>
            <table class='arial11'>
                <tr>
                    <td colspan="3">
                        <?php echo get_lng($_SESSION["lng"], "L0468"); // Download format csv here :?>  <a href="Property/catalogue.csv" target="_blank" download ><img src="../images/csv.jpg" width="16" height="16" border="0"></a>	
                    </td>
                </tr>
				<tr>
                ...
                <tr style="display:none">
                    ...
                    <td>
                        ...
                        <input type="radio" name="rdreplace" value="editall" checked>  <?php echo get_lng($_SESSION["lng"], "L0476"); // Replace All (Delete All first)?>
                    </td>
                </tr>
                <tr>
                    <td></td>
            ...
            <span class="arial21redbold" ><?php echo get_lng($_SESSION["lng"], "L0479"); ?></span><br>
			<span class="arial21redbold" ><?php echo get_lng($_SESSION["lng"], "L0560"); ?></span>
        </form>
              ...
              include "../db/conn.inc";
			   ...
			   $result=$_GET['result'];
                ...
                if($result=='Error'){
                    ...
                    <th>CarMaker</th><th>ModelName</th>
                    <th>PrtPic</th><th>ModelCode</th>
                    <th>EngineCode</th><th>Cc</th>
                    <th>Start</th><th>End</th>
                    <th>Cprtn</th> <th>Prtno</th>
                    <th>ordprtno</th> <th>Prtnm</th> 
                    <th>Vincode</th> <th>Lotsize</th>
                    <th>Brand</th> <th>MTO</th>
                    <th>Remark</th></tr>";
                    $qse="SELECT * FROM supcataloguetemp";
					//echo $qse;
                    $sqlqse=mysqli_query($msqlcon,$qse);
                    while($arrqa2=mysqli_fetch_array($sqlqse)){
                    ...
                    $msgtbl.="</table>";
                    $qd="DELETE FROM supcataloguetemp";
                ...
                if($result=='Add'){
                    ...
                    $qa="SELECT * FROM supcataloguetemp WHERE Owner_Comp='$comp'and supno '$supno'  ";
					//echo $qa;
