...
if(isset($_POST['submit'])){
    ...
    if($flagpro=='upcsv'){
        ...
        $qs2="SELECT Cusno,Itnbr FROM sellpriceAwstmp WHERE StatusItem != 'H' AND Owner_Comp='$comp'";  // edit by CTC
        ...
        while($arr2=mysqli_fetch_array($sqlqs2)){
            ...
            $qs3="SELECT Cusno,Itnbr FROM sellpriceaws WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp' AND Owner_Comp='$comp'";  // edit by CTC
            ...
            if(!$arr3){
                if($radvalact=='add'){
                    ...
                    $qu1="UPDATE sellpriceawstmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp' AND Owner_Comp='$comp'";  // edit by CTC
                ...
                if($radvalact=='edit'){
                    ...
                    $qu2="UPDATE sellpriceawstmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp' AND Owner_Comp='$comp'";  // edit by CTC
