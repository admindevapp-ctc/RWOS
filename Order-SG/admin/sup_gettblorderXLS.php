...
xlsWriteLabel(0,6,"Customer Code");

// mengisi pada cell A8 (baris ke-0, kolom ke-6)
xlsWriteLabel(0,7,"Supplier Code");


// mengisi pada cell A8 (baris ke-0, kolom ke-6)
xlsWriteLabel(0,8,"Remark");
...
$header = ['Customer No.','PO number','PO Date','Part Number','Part Name','QTY','Price','Amount','Due Date','Supplier Code','Remark'];//edit by CTC Pasakorn 03/11/2022
...
//Zia Added for Order Progress	> End
		...
		$data= [$vcust3,$corno,$orddate,$partno,$partdes,number_format($qty,0),strval(number_format($slsprice,2,'.',',')),strval(number_format($slsamt,2,'.',',')),$duedate,$supno,$remark];
...
// menampilkan data nim
		...
		xlsWriteLabel($noBarisCell,8,$remark);       		
		$noBarisCell++;
