...
<script type="text/javascript">
  ...
  <tr class="arial11blackbold">
    ...
    <td colspan="6" class="arial21redbold">Un-Transfered Order</td>
    </tr>
  <tr class="arial11blackbold">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr class="arial11grey" bgcolor="#AD1D36" >
	...
	$query="select * from orderhdr  where trim(Trflg) =''";
...
<p>
 <table width="97%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="arial11blackbold">
    <td width="3%"><img src="images/calendar.gif" width="16" height="15"></td>
    <td colspan="6" class="arial21redbold">Transfered Order</td>
    </tr>
  <tr class="arial11blackbold">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr class="arial11grey" bgcolor="#AD1D36" >
    ...
    <th width="16%" scope="col">action</th>
     ...
     <?
		...
		$query1="select * from orderhdr  where  trim(Trflg) !='' LIMIT $mstart, $per_page"; 
		//echo $query;
