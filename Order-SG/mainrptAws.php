...
$(document).ready(function() {
		...
		$( "#orderdatefrom" ).datepicker('setDate', defa);
		$( "#orderdateto" ).datepicker({
			dateFormat:'mm/dd/yy',								   
			changeMonth: true,
			changeYear: true
		});									   
		$( "#orderdateto" ).datepicker('setDate', mdy);								   
			...
			tips = $( ".validateTips" );
				...
				$('#ConvExcel').click(function(){
					...
					if(txtDateFrom==''){
						...
						url= 'gettblorderXLSaws.php?'+edata;
						window.open(url);	
