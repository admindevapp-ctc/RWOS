...
function checkLengthmax( o, n, min, max ) {
  ...
  <tr class="arial11blackbold">
    ...
    <td colspan="6" class="arial21redbold">Special Sales Price Maintenance</td>
    </tr>
  <tr class="arial11blackbold">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr valign="middle" class="arial11">
    ...
    <? 
	if($type!="v") echo "<a href=\"imspecial.php\"><img src=\"../images/importxls.gif\" width=\"80\" height=\"20\"></a>";
	?>
    </th>
  ...
  <tr class="arial11white" bgcolor="#AD1D36" >
	...
	$query="select * from specialprice where Owner_Comp='$comp'";
	...
	$query1="select * from specialprice where Owner_Comp='$comp' order by cusno, itnbr".		
	...
	$sql=mysqli_query($msqlcon,$query1);	
		...
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vcomp."</td><td>".$vcusno."</td><td>".$vitnbr."</td><td>".$vcurcd."</td><td>".$vprice."</td><td>".$vcust3."</td>" ;
			
			echo "<td class=\"lasttd\">";
			echo "<a href='getspecialprice.php?action=delete&shpno=$vcusno&itnbr=$vitnbr' onclick=\"return confirm('Are you sure you want to delete?')\"> <img src=\"../images/delete.png\" width=\"20\" height=\"20\" border=\"0\"></a>";
