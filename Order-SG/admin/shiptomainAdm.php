...
function checkLengthmax( o, n, min, max ) {
        ...
        <?
		 ...
		 $xprtno='';
		  ...
		  $inpcusno= '<select name="vcusno" id="vcusno" class="arial11blue">';
			...
			$query="select distinct Cusno,ship_to_nm from shiptoma where Owner_Comp='$comp' order by Cusno";
			$sql=mysqli_query($msqlcon,$query);	
			while($hasil = mysqli_fetch_array ($sql)){
				$ycusno=$hasil['Cusno'];
				$ycusnm=$hasil['ship_to_nm'];
  ...
  <tr class="arial11blackbold">
    ...
    <td colspan="6" class="arial21redbold">Ship To MA Inquery</td>
    </tr>
  <tr class="arial11blackbold">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<legend> &nbsp;Search Information</legend>
 <table width="97%" border="0" cellspacing="0" cellpadding="0">
  <tr class="arial11blackbold">
    ...
    <td></td>
    <td><input type="submit" name="button" id="button" value="Search" class="arial11"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr class="tbl1">
...
<table width="100%"  class="tbl1" cellspacing="0" cellpadding="0">
  <tr class="arial11white" bgcolor="#AD1D36" >
  	<th width="5%" scope="col">Company Code</th>
  	<th width="10%" scope="col">Customer</th>
    <th width="5%" scope="col">Ship To</th>
    <th width="10%" scope="col">Ship To Name</th>
    <th width="10%" scope="col">Company Email</th>
    <th width="20%" scope="col">Email Add1</th>
    <th width="20%" scope="col">Email Add2</th>
    <th width="20%" scope="col">Email Add3</th>
    </tr>
	...
	$query="select * from shiptoma". $criteria;
	$sql=mysqli_query($msqlcon,$query);
	...
	$query1="select * from shiptoma". $criteria . " order by Cusno, ship_to_cd ".		
	...
	$sql=mysqli_query($msqlcon,$query1);	
			...
			while($hasil = mysqli_fetch_array ($sql)){
				...
				$vcusno=$hasil['Cusno'];
				$vship_to_cd=$hasil['ship_to_cd'];
				$vship_to_nm=$hasil['ship_to_nm'];
				$vcomp_mail_add=$hasil['comp_mail_add'];
				$vprsn_mail_add1=$hasil['prsn_mail_add1'];
				$vprsn_mail_add2=$hasil['prsn_mail_add2'];
				$vprsn_mail_add=$hasil['prsn_mail_add3'];
				
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vcomp."</td><td>".$vcusno."</td><td>".$vship_to_cd."</td><td>".$vship_to_nm."</td><td>".$vcomp_mail_add."</td><td>".$vprsn_mail_add1."</td><td>".$vprsn_mail_add2."</td>" ;
			
			echo "<td class=\"lasttd\">".$vcomp_mail_add3."";
