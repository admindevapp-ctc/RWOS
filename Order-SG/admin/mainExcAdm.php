...
$(function() {
  ...
  <tr valign="middle" class="arial11">
    ...
    <? 
	if($type!="v") echo "<a href=\"imexchange.php\"><img src=\"../images/importxls.gif\" width=\"80\" height=\"20\"></a>";
	?>
  ...
  <tr class="arial11white" bgcolor="#AD1D36" >
	...
	$query="select * from excrate where Owner_Comp='$comp'";
	...
	$query1="select * from excrate where Owner_Comp='$comp' order by EfDateFr DESC".		
	...
	$sql=mysqli_query($msqlcon,$query1);	
		...
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vcomp."</td><td>".$vcurcd."</td><td>".$vRate."</td><td>".$efdate."</td>" ;
