    ...
    <table width="95%">
        ...
        <tr class="row">
            ...
            <td class="col-xs-2 arial11" rowspan="9"  style=" vertical-align:top;" align="right">
                <a href="../sup_catalogue/<?php echo $result[0]['PrtPic']; ?>" class="img-rounded"  data-lightbox="sub_image-<?php echo $result[0]['ID']; ?>" data-title="<?php echo $result[0]['Prtno']; ?>">
                <img  onError="this.style.display = 'none';" src="../sup_catalogue/<?php echo $result[0]['PrtPic']; ?>" class="img-rounded" style="width:150px; max-height: 150px; display: block; align-content: left;"></a>
            </td>
        </tr>
        <tr class="row">
            <td class="col-xs-2 arial11blackbold">
