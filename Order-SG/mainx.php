	...
	//$( "#dialog:ui-dialog" ).dialog( "destroy" );
		...
		$( "#dialog-form" ).dialog({
			...
			buttons: {
				...
				var vaction="new";
				edata="ordno="+vorderno+"&corno="+vcorno+"&orddate="+vorddate+"&shpno="+vshpno+"&action="+vaction;
	...
	<tr height="5"><td colspan="5"></td><tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  			<tr valign="middle" class="arial11">
    			...
    			<? 
	if($type!="v") echo "<a href=\"imregorder.php\"><img src=\"images/importxls.gif\" width=\"80\" height=\"20\"></a>";
	?>
				</th>
...
<div id="dialog-form" title="New Regular Order" style="display: none;" >
  ...
  <tr class="arial11blackbold">
    ...
    <td colspan="5"  class="arial11blackbold">
      <?
	$qryshp="SELECT cusmas.cusno, cusmas.ESCA1, cusmas.ESCA2, cusmas.ESCA3,  cusrem.curcd, cusrem.remark FROM `cusmas` LEFT JOIN cusrem ON cusmas.cusno = cusrem.cusno  where  trim(cusmas.cust3) ='".$cusno. "' order by cusmas.cusno" ;
	...
	if($mcount==1){
		if($hasil = mysqli_fetch_array ($sqlshp)){
			...
			//$vcusno=$hasil['ESCA1']. ' '.$hasil['ESCA2'] .' ' . $hasil['ESCA3'];
		}
		//echo $vcusno;
		echo "<input name=\"txtShpNo\" type=\"text\"  id=\"txtShpNo\" class=\"arial11blackbold\" readonly=\"true\"  maxlength=\"70\" size=\"70\" value='".$vcusno."'>";
