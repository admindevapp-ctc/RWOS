...
<table cellpadding="0" cellspacing="3" border="0"  width="100%">
	<tr>
	<td width="3%"><img src="../images/calendar.gif" width="15" height="15"></td>	
	...
	<td>Part Picture</td>
	<td>:</td>
	<td> <p><img src="../user_images/<?php echo $PrtPic; ?>" height="200" width="200" /></p><td>
	</tr>
	  </tr>
	    </tr>
   <tr class="arial11blackbold">
		...
		<td>
		<div id="footerMain1">
		<p style="font-size:8px" align="right">Copyright &copy; 2023 DENSO . All rights reserved</P></td>
		</div>
  </tr>
 </table>
</html>
