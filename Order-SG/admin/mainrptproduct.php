...
$(document).ready(function() {
  ...
  <tr class="arial11blackbold">
	...
	<table width="224" border="0">
      <tr>
        <td width="105"><input name="orderdatefrom" id="orderdatefrom" type="text" size="12" maxlength="12" placeholder="dd/mm/yyyy"></td>
        <td width="12">&nbsp;</td>
        <td width="93">
  ...
  <tr class="arial11blackbold">
	...
	<table width="224" border="0">
      <tr>
        <td width="105"><input name="orderdateto" id="orderdateto" type="text" size="12" maxlength="12" placeholder="dd/mm/yyyy"></td>
        <td width="12">&nbsp;</td>
        <td width="93">
		...
		<div style="width: 463px;background-color: white;border-radius: 5px;height: 44px;">
			...
			<div style="width:80%;">
				<div style="float:left; text-align:center;">
					...
					<div><input style="text-align:right;border-radius: 5px;" type="text" name="txtGrandQty" id="txtGrandQty" readonly /></div>
				</div>
				<div style="text-align:center;">
					<div style="font-size: 12px;font-weight: 600;color: #ad1d36;"><?php echo get_lng($_SESSION["lng"], "L0263");//Amount ?></div>
					<div><input style="text-align:right;border-radius: 5px;" type="text" name="txtGrandAmount" id="txtGrandAmount" readonly /></div>
				</div>
			</div>
		</div>
	</th>
