...
foreach ($result->data as $r) {
   ...
   // $sellprice = (double) $r['SellPrice'];
    ...
    $newThing->Detail = '<button type="button" class="btn btn-link btn-sm button-datail" data-cusno="'. $r['Cusno'] .'" data-lot-size="' . $r['Lotsize']. '" value="' . $r['ID'] . '" title="' . get_lng($_SESSION["lng"], "L0430")/* Details */ . '"><span class="glyphicon glyphicon-list-alt"></span></button>';
