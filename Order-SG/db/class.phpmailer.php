...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'root@order.denso.com';
  ...
  */
   ...
   * by SERVER_NAME is used or 'order.denso.com.localdomain'.
   * @var string
   */
  public $Hostname          = '';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or 'order.denso.com.localdomain' if unknown.
   * @access protected
   * @return string
   */
  protected function ServerHostname() {
    if (!empty($this->Hostname)) {
      ...
      $result = 'order.denso.com.localdomain';
    }
