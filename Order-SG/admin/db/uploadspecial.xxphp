...
if(isset($_POST['submit'])){
    ...
    if($flagpro=='upcsv'){
             ...
             if($status!='H'){
                $qi="INSERT INTO specialpricetmp(Cusno, Itnbr, Price, CurCD, CUST2, CUST3,
                    ...
                    ON DUPLICATE KEY UPDATE Cusno='$fcusno',Itnbr='$fitnbr',
                        ...
                        StatusItem='$status',Keterangan='$msg'";
        ...
        // Check duplicate ITNBR AND CUSNO in specialpricetmp table
        $qs2="SELECT Cusno,Itnbr FROM specialpricetmp WHERE StatusItem != 'H'";
        ...
        while($arr2=mysqli_fetch_array($sqlqs2)){
            ...
            // Get cusno and itnbr from specialprice table
            $qs3="SELECT Cusno,Itnbr FROM specialprice WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
            ...
            if(!$arr3){
                if($radvalact=='add'){
                    ...
                    $qu1="UPDATE specialpricetmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
                ...
                if($radvalact=='edit'){
                    ...
                    $qu2="UPDATE specialpricetmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
