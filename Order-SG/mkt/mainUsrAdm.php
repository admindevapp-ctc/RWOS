...
<script type="text/javascript">
  ...
  <tr class="arial11grey" bgcolor="#AD1D36" >
	...
	$query1="select * from userid   order by Cusno".		
	       " LIMIT $start, $per_page";
	$sql=mysqli_query($msqlcon,$query1);	
		
			while($hasil = mysqli_fetch_array ($sql)){
				$vcusno=$hasil['Cusno'];
				$query2="select Cusnm from cusmas where cust3='".$vcusno ."'";
		...
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vuser."</td><td>".$vcusnm."</td><td>".$vcusno."</td>" ;
			echo "<td>".$type."</td>";
