...
//	$sql = " SELECT  count(*) as count from (select count(*) as jml FROM orderdtl INNER JOIN bm008pr ON orderdtl.partno = bm008pr.itnbr".
//" where orderdtl.cust3='$cusno' and orderdtl.orderdate>='$datefrom' and orderdtl.orderdate<='$dateto' GROUP BY Product, subprod, orderdate, corno ORDER BY Product, subprod, orderdate, corno) as tbl"; 

	$sql = " SELECT  count(*) as count from (select count(*) as jml FROM orderdtl INNER JOIN bm008pr ON orderdtl.partno = bm008pr.itnbr AND orderdtl.Owner_Comp = bm008pr.Owner_Comp ".
" where orderdtl.cusno in $comp and orderdtl.orderdate>='$datefrom' and orderdtl.orderdate<='$dateto' and orderdtl.Owner_Comp='$owner_comp' GROUP BY Product, subprod, orderdate, corno ORDER BY Product, subprod, orderdate, corno) as tbl"; 
