			...
			{	
               ...
               // echo $supno."<br/>";
				...
				{     //PO tidak sama debgan kosong
                    ...
                    $query="select distinct Prtnm as ITDSC,LotSize from supcatalogue where  Owner_Comp='$comp' and prtno = '$PartNo' and Supcd = '$supno'";
			 		//echo $query;
					$sql=mysqli_query($msqlcon,$query);		
					if($hasil = mysqli_fetch_array ($sql)){
                                   ...
                                   //     echo $qry ."<br/>";
										if($hsle){
									 	...
									 	//echo $partdes;
                                            ...
                                            where supcatalogue.Prtno ='$PartNo'  and supcatalogue.Supcd = '$supno' 
                                            ";
											echo $query."<br>";
											 $sql=mysqli_query($msqlcon,$query);		
											 if($hasil = mysqli_fetch_array ($sql))
