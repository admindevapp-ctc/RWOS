...
$(document).ready(function() {
			...
			tips = $( ".validateTips" );
				...
				$('#ConvExcel').click(function(){
					...
					if(txtDateTo<txtDateFrom){
						alert('<?php echo get_lng($_SESSION["lng"], "G0006"); ?>'/*'Date to should be greater than date from!'*/);
						return;
					}	
  ...
  <tr class="arial11blackbold">
    <td width="22%"><?php echo get_lng($_SESSION["lng"], "L0248"); ?><!--Customer Number--></td>
    <td width="2%">:</td>
    <td width="26%"><? echo $cusno ?></td>
    <td width="4%"></td>
    <td width="20%"><?php echo get_lng($_SESSION["lng"], "L0249"); ?><!--Customer Name--></td>
    <td width="2%">:</td>
  ...
  <tr class="arial11blackbold">
    <td><?php echo get_lng($_SESSION["lng"], "L0250"); ?><!--Order Date From--></td>
    <td>:</td>
    <td>
  ...
  <tr class="arial11blackbold">
    <td><?php echo get_lng($_SESSION["lng"], "L0251"); ?><!--Order Date To--></td>
    <td>:</td>
    <td> 
	<table width="224" border="0">
      <tr>
        ...
        <td width="12">&nbsp;</td>
        <td width="93">
          <input name="cmdGo" type="submit" class="arial11" id="cmdGo" value="<?php echo get_lng($_SESSION["lng"], "L0234")/*Find*/; ?> ">
        </td>
      </tr>
    </table>
</td>
...
<thead >
	  ...
	  <tr align="center" height="20"  class="arial11Redbold" >
		  <th width="67%"></th>
			...
			<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0235"); ?><!--QTY--></th>
            <th width="15%"><?php echo get_lng($_SESSION["lng"], "L0236"); ?><!--AMOUNT--></th>
	...
	<tbody>
		<tr>
			...
			<th width="67%" align="right"><?php echo get_lng($_SESSION["lng"], "L0237"); ?><!--GRAND TOTAL--></th>
			<th width="15%"><label>
...
<thead >
		...
		<tr align="center" height="20" >
			<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0258"); ?><!--PO Number--></th>
           	<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0259"); ?><!--Sub Product--></th>
      		<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0260"); ?><!--Order Type--></th>
			<th width="10%"><?php echo get_lng($_SESSION["lng"], "L0261"); ?><!--order date --></th>
                
			<th width="10%"><?php echo get_lng($_SESSION["lng"], "L0262"); ?><!--Qty--></th>
            <th width="20%" class="lastth"><?php echo get_lng($_SESSION["lng"], "L0263"); ?><!--Amount--></th>
