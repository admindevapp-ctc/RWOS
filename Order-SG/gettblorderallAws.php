...
{       
	...
	$sQuery = "SELECT partno, orderhdr.cusno, orderhdr.orderno, orderhdr.Corno, orderhdr.orderdate, orderhdr.Dealer, itdsc,  ordtype, qty  from orderhdr inner join orderdtl on orderhdr.orderno=orderdtl.orderno and orderhdr.Owner_Comp=orderdtl.Owner_Comp ".
