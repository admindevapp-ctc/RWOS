...
$(function() {
  ...
  <tr class="arial11grey" bgcolor="#AD1D36" >
  	<th width="40%" scope="col">Period (YYYYMM)</th>
	...
	$query1="select * from CutOfDate   order by Period DESC".		
	...
	$sql=mysqli_query($msqlcon,$query1);	
		...
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vPeriode."</td><td>".$cutdate."</td>" ;
 ...
 <tr>
    <td colspan="3"  align="right" class="lasttd" ><img src="../images/edit.png" width="20" height="20"><span class="arial11redbold"> = edit</span></td>
    </tr> 
</table>
