...
" where orderdtl.Owner_Comp='$comp' and orderdtl.orderdate>='$datefrom' and orderdtl.orderdate<='$dateto'"; // edit by CTC 
...
$sql=$sql . " GROUP BY CUST3, Product, subprod, orderdate, corno ORDER BY Product, subprod, orderdate, corno) as tbl"; 
