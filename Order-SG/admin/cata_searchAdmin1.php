...
// Popup window code
	...
	popupWindow = window.open(
		url,'popUpWindow','height=570,width=400,left=500,top=300,resizable=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=no')
}		 
...
<form method="post" action="searchbykey.php" id="orderdatefrom">
	...
	<input type="text" name="txtsearch" placeholder="Type to Search" size="25" /><input type="submit" name="cmdsearch" value="Search" class="arial11"/>
	</td>
</form>	
    <td>&nbsp;</td>
	<td>&nbsp;</td>
...
if ($cat == "" && $subcat == "" && $subcat3 == "") {
  ...
  //echo $sql;
	...
	?>
			...
			<td><img src="admin/user_images/<?php echo $dix[3]; ?>" class="img-rounded" width="40px" height="40px" </td>
