	...
	<body >
		...
		<table width="97%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="arial11blackbold">
                ...
                <td colspan="5" class="arial21redbold"><?php echo get_lng($_SESSION["lng"], "M006"); // Supplier Sale Price?> </td>
        ...
        <?php echo get_lng($_SESSION["lng"], "L0468"); // Download format csv here :?>  <a href="Property/supprice.csv" target="_blank" download ><img src="../images/csv.jpg" width="16" height="16" border="0"></a>	
             <form method="POST" enctype="multipart/form-data" name="uploadForm" action='Property/uploadsupprice.php' id='frmimport' >
            <table class='arial11'>
				<tr>
              ...
              include "../db/conn.inc";
			   ...
			   $result=$_GET['result'];
                ...
                if($result=='Error'){
                    $msgtbl="<H3>Error ".$msg."</H3><table width='100%'  class='tbl1' cellspacing='0' cellpadding='0'>
 						 <tr class='arial11whitebold' bgcolor='#AD1D36' >
                            <th width='15%' height='30' scope='col'>Cusno</th>
                            <th width='15%' height='30' scope='col'>Supno</th>
                            <th width='20%' height='30' scope='col'>Partno</th>
                            <th width='20%' height='30' scope='col'>Curr</th>
                            <th width='20%' height='30' scope='col'>Price</th>
                            <th width='10%' height='30' scope='col'>Shipto</th>
                        </tr>";
                    $qse="SELECT * FROM suppricetemp WHERE Owner_Comp='$comp' and supno '$supno' ";
					//echo $qse;
                ...
                if($result=='Add'){
                    ...
                    $qa="SELECT * FROM suppricetemp WHERE Owner_Comp='$comp'and supno '$supno'  ";
					//echo $qa;
                    ...
                    while($arrqa=mysqli_fetch_array($sqlqa)){
						...
						$price=$arrqa['price'];
						$shipto=$arrqa['shipto'];
                        $qi2="Replace INTO supprice(Owner_comp, Cusno, supno, partno, curr, price, shipto
                        )  VALUES('$comp', '$cusno', '$supno'
						, '$partno', '$curr', '$price', '$shipto')"; 
