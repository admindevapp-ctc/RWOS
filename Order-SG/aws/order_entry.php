...
$table = ctc_get_session_awstable();
        ...
        function number_format(nStr) {
            ...
            $(function () {
                                        ...
                                        if (data.substr(0, 5) === 'Error' || data.substr(0, 7) === 'ผิดพลาด') {
                                            ...
                                            if (vaction === 'add') {
                                                $('#myTable > tbody:last').append("<tr>" +
                                                        ...
                                                        "<td style=\"padding-left:5px;\">" + partno.val().toUpperCase() + " - " + itdsc + "</td>" +
                                                        "<td align=\"center\" class=\"qty\" >" + qty.val() + "</td>" +
                                                        "<td align=\"center\" class=\"curcd\" >" + curcd + "</td>" +
                                                        "<td style=\"padding-right:5px;\" class=\"price\" align=\"right\">" + bprice + "</td>" +
                                                        "<td style=\"padding-right:5px;\" class=\"ttl\" align=\"right\">" + ttlprice + "</td>" +
                ...
                $("#cmdSave").click(function () {
                    ...
                    var Shipment = $("#shipment").val();
                    edata = "orderno=" + orderno + "&corno=" + corno + "&shpno=" + shpno + "&action=" + action + "&ordertype=" + ordertype + "&shpCd=" + shpCd + "&txtnote=" + txtnote + "&Shipment=" +Shipment;//12/20/2018 P.Pawan CTC add parameter shpCd
            ...
            <div id="twocolRight1">
                        ...
                        <td colspan="5">
                            <table width="97%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    $query = "select '' ship_to_nm,ship_to_cd2,ship_to_adrs1 adrs1 
                                        ,ship_to_adrs2 adrs2,ship_to_adrs3 adrs3,'' pstl_cd,'' comp_tel_no 
                                    from `awscusmas` 
                ...
                <table class="tblorder"  width="97%" border="0" cellpadding="0" cellspacing="0"  id="myTable">
                    <tbody>
                        ...
                        <?php
                        $ctcdb = new ctcdb();
                        $sql = "select a.* from $table a where trim(a.cusno) ='" . $vcusno . "' and trim(a.orderno)='" . $xordno . 
                        "' and Owner_Comp='$comp' order by a.partno";
                       // echo $sql;
                        ...
                        foreach ($result as $hasil) {
                            ...
                            echo "<td style=\"padding-right:5px;\" class=\"ttl\" align=\"right\">" . $ttl . "</td>";
