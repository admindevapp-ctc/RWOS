            ...
            <?
			   ...
			   $msg=$_GET['msg'];
                ...
                if($msg=='Error'){
                    ...
                    $qse="SELECT * FROM specialpriceawstmp WHERE StatusItem='E'";
					//echo $qse;
                ...
                if($msg=='Add'){
					...
					$qi2.=" SELECT Cusno, Itnbr,PriceAWS,CurCDAWS,Price,CurCD,DlrCD FROM specialpriceawstmp WHERE StatusItem !='H'";
                ...
                if($msg=='Replace'){
                    $msgsuccess='Replace data success';
                     $qu3="SELECT Cusno, Itnbr,PriceAWS,CurCDAWS,Price,CurCD,DlrCD FROM specialpriceawstmp WHERE StatusItem !='H'";
                ...
                if($msg=='Confirm'){
                    // Check count 
                    $qc1="SELECT COUNT(*) AS fcount FROM specialpriceaws";
                    $sqlqc1=mysqli_query($msqlcon,$qc1);
                    $arqc1=mysqli_fetch_array($sqlqc1);
                    $fcount=$arqc1['fcount'];
                        
                    $qc2="SELECT COUNT(*) AS tmpcount FROM specialpriceawstmp WHERE StatusItem!='H'";
                    ...
                    <?
                        $qa2="SELECT Cusno, Itnbr,PriceAWS,CurCDAWS,Price,CurCD,DlrCD FROM specialpriceawstmp WHERE StatusItem!='H' LIMIT 10";
