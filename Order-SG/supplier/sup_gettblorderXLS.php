...
//Zia Added for Order Progress	> End
			...
			$data= [$corno,$orddate,$partno,$partdes,$duedt,number_format($qty,2),number_format($slsprice,2),number_format($slsamt,2),$supno,$remark];
...
/*		xlsWriteLabel($noBarisCell,0,$partno);
		xlsWriteLabel($noBarisCell,1,$partdes);
		xlsWriteLabel($noBarisCell,2,$corno);
 		xlsWriteLabel($noBarisCell,3,$orddate);
		xlsWriteLabel($noBarisCell,4,$duedate);
		xlsWriteNumber($noBarisCell,5,$cusno);
