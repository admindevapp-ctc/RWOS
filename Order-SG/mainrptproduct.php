...
var date1=new Date();
			...
			tips = $( ".validateTips" );
				...
				$('#ConvExcel').click(function(){
					...
					if(txtDateTo<txtDateFrom){
						alert('<?php echo get_lng($_SESSION["lng"], "G0005"); ?>'/*'Date to should be greater than date from!'*/);
						return;
					}	
  ...
  <tr class="arial11blackbold">
    <td width="22%"><?php echo get_lng($_SESSION["lng"], "L0230"); ?><!--Customer Number--></td>
    <td width="2%">:</td>
    <td width="26%"><? echo $cusno ?></td>
    <td width="4%"></td>
    <td width="20%"><?php echo get_lng($_SESSION["lng"], "L0231"); ?><!--Customer Name--></td>
    <td width="2%">:</td>
  ...
  <tr class="arial11blackbold">
    <td><?php echo get_lng($_SESSION["lng"], "L0232"); ?><!--Order Date From--></td>
    <td>:</td>
    <td>
  ...
  <tr class="arial11blackbold">
    <td><?php echo get_lng($_SESSION["lng"], "L0233"); ?><!--Order Date To--></td>
    <td>:</td>
    <td> 
	<table width="224" border="0">
      <tr>
...
<thead >
	  ...
	  <tr align="center" height="20"  class="arial11Redbold" >
            ...
            <th width="15%"><?php echo get_lng($_SESSION["lng"], "L0236"); ?><!--L0236--></th>
...
<thead >
		...
		<tr align="center" height="20" >
			<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0238"); ?><!--Product--></th>
           	<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0239"); ?><!--Subproduct--></th>
      		<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0240"); ?><!--PO Number--></th>
			<th width="10%"><?php echo get_lng($_SESSION["lng"], "L0241"); ?><!--order date --></th>
			<th width="10%"><?php echo get_lng($_SESSION["lng"], "L0242"); ?><!--Qty--></th>
            <th width="20%" class="lastth"><?php echo get_lng($_SESSION["lng"], "L0243"); ?><!--Amount--></th>
