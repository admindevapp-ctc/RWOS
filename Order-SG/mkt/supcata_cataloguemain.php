        ...
        $('#ConvExcel').click(function () {
                ...
                function UpdateMakerList() {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $("#cbocatmaker").empty();
                            $("#cbocatmaker").append('<option value="0" selected="selected"><?php echo get_lng($_SESSION["lng"], "L0340")/* Select Maker */; ?></option>');
                ...
                function UpdateSupplierList() {
                    $.ajax({
                        ...
                        success: function (response) {
                            var decodeJson = JSON.parse(response);
                            $("#cbocatsup").empty();
                            $("#cbocatsup").append('<option value="" selected="selected"><?php echo get_lng($_SESSION["lng"], "L0444")/* Select Supplier */; ?></option>');
                            $.each(decodeJson, function (key, value)
                            {
                ...
                table = $('#tablecatalog').removeAttr('width').DataTable({
                        ...
                        complete: function (result) {
                           // console.log(result);
                            ...
                            $('.button-datail').on('click', function () {
                                ...
                                $.ajax({
                                    url: "supcataloguemain/_cata_supdetails_modal.php",
                                    type: 'post',
                                    data: {edit_id: edit_id, lotsize: lotSize,cusno :cusno},
                                    success: function (data) {
                    ...
                    'columnDefs': [
                        ...
                        {width: 50, targets: 1},//Car
                        {width: 40, targets: 2},//Model
                        {width: 70, targets: 3},//Vin
                        {width: 60, targets: 4},//Model
                        {width: 60, targets: 5},//En
                        {width: 60, targets: 6},//Ge
                        {width: 50, targets: 7},//Sup
                       // {width: 40, targets: 8},//Pic
                        {width: 40, targets: 8},//Brand
                        {width: 70, targets: 9},//Partnm
                        {width: 70, targets: 10},//Part
                        {width: 40, targets: 11},//Detail
                        {width: 50, targets: 12},//price
...
<body >
    ...
    <div class="col-md-12 margin-bottom-md" style="padding-right: 40px;">
                <div class="row">
                    <div class="col-md-3 arial21redbold">
                        <img src="../images/cata.png" width="17" height="15">&nbsp; <?php echo get_lng($_SESSION["lng"], "L0551")/* Part Calalogue */; ?>
                    </div>
                </div>
