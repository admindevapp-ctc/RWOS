...
function checkLengthmax( o, n, min, max ) {
		...
		$( "#dialog-form" ).dialog({
			...
			//alert(bValid);
				...
				var vcust2=cust2.val();
				var vcust3=cust3.val();
				var edata;
				
				edata="shpno="+vshpno +"&itnbr="+vitnbr+"&curcd="+vcurcd+"&price="+vprice+"&cust2="+vcust2+"&cust3="+vcust3+"&action="+vaction;
				alert(edata);
...
<div id="dialog-form" title="Add Order Detail" >
				<p class="validateTips">All form fields are required.</p>
					...
					<form>
                    <fieldset>
						  <label for="Customer Number" class="arial11redbold">Customer Number</label><input type="text" size="12" maxlength="10" name="shpno" id="shpno"  />
						  <br>
                          <fieldset>
						  <label for="Item Number" class="arial11redbold">Item Number</label><input type="text" size="18" maxlength="15" name="itnbr" id="itnbr"  />
						  <br>
						<fieldset>
						  <label for="CurCD" class="arial11redbold">Currency Code</label><input type="text" size="3" maxlength="2" name="curcd" id="curcd"  />
						 <br>
						  <label for="Salesprice" class="arial11redbold">Sales Price</label>
			        <input type="text" name="slsprice" id="slsprice"  /> 
							<br>
        <label for="cust2" class="arial11redbold">Cust2</label>
        
						  <input type="text" name="cust2" id="cust2" /> 
						<br>
                         <label for="cust3" class="arial11redbold">Cust3</label>
        				  <input type="text" name="cust3" id="cust3" /> 
						<br>
