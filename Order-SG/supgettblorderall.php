...
$cusnm = ctc_get_session_cusnm();
	...
	*/
	...
	$sql = "SELECT * from suporderhdr inner join suporderdtl on suporderhdr.orderno=suporderdtl.orderno and suporderhdr.Owner_Comp=suporderdtl.Owner_Comp where suporderhdr.orderdate>='$datefrom' and suporderhdr.orderdate<='$dateto' and suporderhdr.Owner_Comp='$owner_comp' and suporderhdr.cusno ='$cusno'";
//	echo $sql;
...
$sQuery_from = " from suporderhdr inner join suporderdtl on suporderhdr.orderno=suporderdtl.orderno and suporderhdr.Owner_Comp=suporderdtl.Owner_Comp  and suporderhdr.Corno = suporderdtl.Corno ".
	...
	" where suporderhdr.orderdate>='$datefrom' and suporderhdr.orderdate<='$dateto' and suporderhdr.Owner_Comp='$owner_comp'  and suporderhdr.cusno ='$cusno'" ; //edit by CTC Pasakorn 03/11/2022
...
if($search!=''){
	 ...
	 if($namafield!=''){
			...
			$sQuery_from = $sQuery_from . " order by  suporderhdr.orderdate desc ,suporderhdr.Corno, partno";		   
	  }	
...
//Zia Added for Order Progress	> End
		...
		$odrsts=$aRow['ordtype'];
			...
			echo "</tr>"; //edit by CTC Pasakorn 03/11/2022
				}
	if($i=="1") echo "</table>";
