        ...
        <script>
            ...
            $(document).ready(function () {
                $('#ConvExcel').click(function () {
                    ...
                    url = 'supcataloguemain/supcata_gettblcatalogueXLSX.php?CatMaker=' + CatMaker + '&ModelName=' + ModelName
                            + '&ModelCode=' + ModelCode + '&SubCatMaker=' + SubCatMaker + '&SubModelName=' + SubModelName
                            + '&Brand=' + Brand + '&Supplier=' + Supplier+ '&SearchTable='+ SearchTable,
                       window.open(url);
                })
                ...
                function UpdateMakerList() {
                    $.ajax({
                        url: "supcataloguemain/ctcGetCalalogueCarmakerAjax.php",
                        type: 'post',
                ...
                function UpdateModelNameList() {
                    $.ajax({
                        url: "supcataloguemain/ctcGetCalalogueModelNameAjax.php",
                        type: 'post',
                ...
                function UpdateModelCodeList() {
                    $.ajax({
                        url: "supcataloguemain/ctcGetCalalogueModelCodeAjax.php",
                        type: 'post',
                ...
                function UpdateBrandList() {
                    $.ajax({
                        url: "supcataloguemain/ctcGetBrandAjax.php",
                        type: 'post',
                        data: {CarMaker: $('#cbocatmaker').val(), ModelName: $('#cbocatmodel').val()},
                        success: function (response) {
                            //console.log(response);
                ...
                function UpdateSupplierList() {
                    $.ajax({
                        ...
                        success: function (response) {
                            var decodeJson = JSON.parse(response);
                            $("#cbocatsup").empty();
                            $("#cbocatsup").append('<option value="0" disabled="disabled" selected="selected"><?php echo get_lng($_SESSION["lng"], "L0444")/* Select Supplier */; ?></option>');
                            $.each(decodeJson, function (key, value)
                            {
                                $("#cbocatsup").append('<option value="' + value.supno + '">' + value.supno +' : '+ value.supnm + '</option>');
                            });
                        }
                    })
                }
                ...
                function UpdateSubCategory() {
                    $.ajax({
                        url: "supcataloguemain/ctcGetCalalogueSubCatagoryAjax.php",
                        type: 'post',
                        data: {
                ...
                function ReloadCarousel() {
                    $('#cartBadge').empty();
                    $.ajax({
                        url: "supcataloguemain/ctcGetAnnounceAjax.php",
                        type: 'post',
                        success: function (response) {
                            //console.log(response);
                            var decodeJson = JSON.parse(response);
                ...
                $(".buttonAddToCartSub").on('click', function () {
                    ...
                    //alert(quantity);
                    $.ajax({
                        url: "supcataloguemain/ctcSubmitAddToCartAjax.php",
                        type: 'post',
                ...
                $( "#cbocatsup" ).change(function() {
                    var cbocatsup = $('#cbocatsup').val();
                    if (cbosubcatmaker !== null && submodelname !== null && submodelname !== '') {
                        ResetSearch();
                        $('#searchSubCat').val(cbosubcatmaker);
                        $('#searchSubCatName').val(submodelname);
                ...
                function UpdateSideDetail(box) {
                    ...
                    if (currentSideBar !== edit_id) {
                        ...
                        //alert(edit_id);
                        //alert("ID=" + first + "Edit=" + edit_id);
                        $.ajax({
                            url: "supcataloguemain/_cata_details_sidebar.php",
                            type: 'post',
                ...
                table = $('#tablecatalog').removeAttr('width').DataTable({
                    ...
                    ajax: {
                        url: 'supcataloguemain/ctcGetCalalogueTableAjax.php',
                        dataType: "json",
                        type: "POST",
                        data: function (data) {
                            ...
                            data.Supplier = $('#searchSupplier').val();
                        },
                        beforeSend: function () {
                        ...
                        complete: function (result) {
                            ...
                            $(".buttonAddToCart").on('click', function () {
                                ...
                                var quantity =$('#quantity' + $(this).val()).val();
                                var id = paramArr[0];//$(this).data('id');
                                var supno = paramArr[1];
                                ...
                                $.ajax({
                                    url: "supcataloguemain/ctcSubmitAddToCartAjax.php",
                                    type: 'post',
                                    data: {ID: id, Quantity: quantity, Supno: supno},
                                    success: function (response) {
                                        //alert(response);
                                        var decodeJson = JSON.parse(response);
                                        if (decodeJson.errorCode === '0000') {
                            ...
                            $('.button-datail').on('click', function () {
                                ...
                                $.ajax({
                                    url: "supcataloguemain/_cata_details_modal.php",
                                    type: 'post',
                                    data: {edit_id: edit_id, lotsize: lotSize},
                                    success: function (data) {
                    ...
                    'columnDefs': [
                        ...
                        {width: 50, targets: 3},//vincode
                        {width: 50, targets: 4},//model code
                        {width: 70, targets: 5},//en code
                        {width: 70, targets: 6},//ge part
                        {width: 70, targets: 7},//sup part
                       // {width: 60, targets: 8},
                        {width: 40, targets: 8},//brand
                        {width: 100, targets: 9},//part name
                        {width: 100, targets: 10},//order part
                        {width: 40, targets: 11},//detail
                        {width: 50, targets: 12},//std price
                        {width: 40, targets: 13},//lotsize
                        {width: 40, targets: 14},//stock
                        {width: 100, targets: 15},//Add to cart
                    ]
                });
            });
        </script> 
            ...
            <div class="col-md-12 margin-bottom-md" style="padding-right: 40px;">
                <div class="row" style="padding-bottom:10px;">
                    <div class="col-md-6 arial21redbold">
                        <img src="../images/cata.png" width="17" height="15">&nbsp; <?php echo get_lng($_SESSION["lng"], "L0551")/*Sup Part Calalogue */; ?>
                    </div>
                    <div class="col-md-6 text-right" style="font-size: 18px; padding-right:0px">
                ...
                <div class="row arial11blackbold divmiddle">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <div class="col-md-3 col-sm-3">
                            <?php echo get_lng($_SESSION["lng"], "L0443")/* Supplier Name */; ?>&nbsp;&nbsp;:&nbsp;&nbsp;
                        </div>&nbsp;
                        <div class="col-md-6 col-sm-3">
                            <select class="form-control input-xs" id="cbocatsup" name="cbocatsup">
                                <option disabled="disabled" selected="selected"><?php echo get_lng($_SESSION["lng"], "L0444")/* Select Supplier */; ?></option>
                            </select>
                        </div>
                        <!--  <div class="col-md-3 col-sm-3">
                               <button type="button" class="btn btn-success btn-sm btn-w-m" id="buttonSupSearch" title="<?php echo get_lng($_SESSION["lng"], "L0427")/* Search */; ?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                        </div>-->
                    </div>
                    <div align="center" class="col-md-5 col-sm-6" style="padding:0px">
                        <div class="col-md-12" style="height:80; padding-right:0px;">
                ...
                <div class="row arial11black">
                    <div class="col-md-5 margin-top-md">
                        <div class="col-md-12 custom-box bg-skyblue">
                            ...
                            <input type="hidden" id="searchSupplier" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-inline">
                                ...
                                <div class="col-md-6" align="right">   
                                    <?php 
                                        $url = "supimport_order_new.php?" . paramEncrypt("ordertype=Request"); 
                                    ?>                                 
                                    <button type="button" class="btn btn-maroon btn-xs arial11white" onclick="window.location.href = '<?php echo $url;?>'" title="<?php echo get_lng($_SESSION["lng"], "L0371")/* Browe*/; ?>"><span class="glyphicon"></span> <?php echo get_lng($_SESSION["lng"], "L0172")/* Import*/; ?> </button>
                                ...
                                <table id="tablecatalog" class="table table-bordered table-hover display" style="overflow-x: auto;" cellspacing="0">
                                    <thead>
                                        <tr class="bg-maroon">
                                            ...
                                            <th class="text-center" style="width:100px"><?php echo get_lng($_SESSION["lng"], "L0364")/* Add to cart */; ?></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
