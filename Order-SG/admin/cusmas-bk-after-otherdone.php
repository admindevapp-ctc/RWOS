...
<script type="text/javascript">
    ...
    <?php ctc_get_logo(); ?> <!-- add by CTC -->
		...
		if(trim($_GET['action'])=='add'){
			$inpcusno="<input type=\"text\" name=\"vcusno\" class=\"arial11blackbold\" maxlength=\"8\" size=\"9\" required></input>";
			...
			$inptype="<input type=\"text\"  name=\"vtype\" class=\"arial11black\" maxlength=\"10\" size=\"10\" required></input>";
