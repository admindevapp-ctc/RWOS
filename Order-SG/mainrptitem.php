...
var date1=new Date();
			...
			tips = $( ".validateTips" );
				...
				$('#ConvExcel').click(function(){
					...
					if(txtDateTo<txtDateFrom){
						alert('<?php echo get_lng($_SESSION["lng"], "G0008"); ?>'/*'Date to should be greater than date from!'*/);
						return;
					}	
  ...
  <tr class="arial11blackbold">
    <td width="22%"><?php echo get_lng($_SESSION["lng"], "L0269"); ?><!--Customer Number--></td>
    <td width="2%">:</td>
    <td width="26%"><? echo $cusno ?></td>
    <td width="4%"></td>
    <td width="20%"><?php echo get_lng($_SESSION["lng"], "L0270"); ?><!--Customer Name--></td>
    <td width="2%">:</td>
  ...
  <tr class="arial11blackbold">
    <td><?php echo get_lng($_SESSION["lng"], "L0271"); ?><!--Order Date From--></td>
    <td>:</td>
    <td>
  ...
  <tr class="arial11blackbold">
    <td><?php echo get_lng($_SESSION["lng"], "L0272"); ?><!--Order Date To--></td>
    <td>:</td>
    <td> 
	<table width="224" border="0">
      <tr>
        ...
        <td width="12">&nbsp;</td>
        <td width="93">
          <input name="cmdGo" type="submit" class="arial11" id="cmdGo" value="<?php echo get_lng($_SESSION["lng"], "L0274");/*Find */ ?>">
        </td> 
      </tr>
    </table>
    </td>
...
<thead >
	  ...
	  <tr align="center" height="20"  class="arial11Redbold" >
		  <th width="67%"></th>
			...
			<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0276"); ?><!--QTY--></th>
            <th width="15%" class="lastth"><?php echo get_lng($_SESSION["lng"], "L0277"); ?><!--AMOUNT--></th>
	...
	<tbody>
		<tr>
			...
			<th width="67%" align="right"><?php echo get_lng($_SESSION["lng"], "L0275"); ?><!--GRAND TOTAL--></th>
			<th width="15%"><label>
			  <input type="text" name="txtGrandQty" id="txtGrandQty" style="text-align: right" disabled="disabled">
	      </label></th>
            <th width="15%" class="lastth"><input type="text" name="txtGrandAmount" id="txtGrandAmount" style="text-align: right" disabled="disabled"></th>
...
<thead >
	...
	<tr align="center" height="20" >
		<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0280"); ?><!--Part Number--></th>
		<th width="15%"><?php echo get_lng($_SESSION["lng"], "L0281"); ?><!--Product--></th>
        <th width="15%"><?php echo get_lng($_SESSION["lng"], "L0282"); ?><!--Subproduct--></th>
        <th width="15%"><?php echo get_lng($_SESSION["lng"], "L0283"); ?><!--PO Number--></th>
		<th width="10%"><?php echo get_lng($_SESSION["lng"], "L0284"); ?><!--order date --></th>
        <th width="10%"><?php echo get_lng($_SESSION["lng"], "L0285"); ?><!--Qty--></th>
        <th width="10%"class="lastth"><?php echo get_lng($_SESSION["lng"], "L0286"); ?><!--Amount--></th>
	   <!-- <th width="10%" class="lastth">Amount SG</th> -->
		</tr>
	</thead>
	<tbody>
		<tr>
