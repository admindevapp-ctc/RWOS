        ...
        if(bi!=''){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(valid=='Error'){
                        $('#result').html(data);
                        $('#result').css('background-color','#e50429');
                    }else{
                    ...
                    .append("<p class='Arial11Grey'> <a href='../logout.php' >Return to login Screen</a> or <a href='supmaincusadm.php' >Return to Main screen</a>")
            ...
            <td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="69%" class="arial11black"><? echo $supno ?></td>
                    </tr>
                    <tr>
                        ...
                        <td class="arial11black"><? echo $supnm ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="function">
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" >
                                ...
                                <td>:</td>
                                <td><input name="NewPassword" type="password" id="NewPassword" size="25" maxlength="20" /></td>
