...
header("Location:../../login.php");
	...
	$query="delete from ".$awstable. " where cusno ='".$cusno. "' and Owner_Comp='$comp' "; // edit by CTC
	echo $query;
	mysqli_query($msqlcon,$query);
	$table1=str_replace("regimp",'ordtmp',$awstable);
	...
	$xordno="AWS".$alias.$vordno.substr($ordertype,0,1);
