...
//    $quantityButtonCart = '<button type="button" class="btn btn-success btn-xs" disabled>&nbsp;<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></button>';
//    $quantityMessage = '<span class="arial21redbold">' . get_lng($_SESSION["lng"], "E0041")/* Price or Item not found */ . '</span>';
//} else {
//    $quantityButtonCart = '<button type="button" class="btn btn-success btn-xs buttonAddToCartSub" data-id="' . $uid . '" value="' . $uid . '">&nbsp;<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></button>';
//    $maxLot = 999 - (999 % $lotsize);
//    $quantityBox = '<input class="touchspinQuantitySub form-control input-xs text-center" id="quantitySub' . $uid . '" type="text" value="0" name="quantitySub' . $uid . '"'
//            . ' data-bts-step="' . $lotsize . '" data-bts-mousewheel="true" data-bts-min="' . $lotsize . '" data-bts-max="' . $maxLot . '">';
//}

////TODO Test query logic sumeta
if ($erp == '0') {
    //check qbm008pr
