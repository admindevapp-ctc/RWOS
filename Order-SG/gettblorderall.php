...
{       
	...
	$sql = "SELECT * from orderhdr inner join orderdtl on orderhdr.orderno=orderdtl.orderno and orderhdr.Owner_Comp=orderdtl.Owner_Comp where orderhdr.cusno in $comp and orderhdr.orderdate>='$datefrom' and orderhdr.orderdate<='$dateto' and orderhdr.Owner_Comp='$owner_comp' ";
...
//			  " where orderhdr.cust3='$cusno' and orderhdr.orderdate>='$datefrom' and orderhdr.orderdate<='$dateto'" ;
			$sQuery_select ="SELECT orderdtl.slsprice,orderhdr.CUST3,orderhdr.cusno, partno, orderhdr.orderno, itdsc, orderhdr.Corno, orderhdr.orderdate, ordtype,DueDate, qty,vt_cst_ordr_prog.INV_NO,vt_cst_ordr_prog.SHPD_YMD,vt_cst_ordr_prog.SHPD_QTY,vt_cst_ordr_prog.CST_ORDR_LN_CMPLT_FLG,vt_cst_ordr_prog.CST_ORDR_QTY ";
			$sQuery_from = "from orderhdr inner join orderdtl on orderhdr.orderno=orderdtl.orderno and orderhdr.Owner_Comp=orderdtl.Owner_Comp ".
				...
				" where orderhdr.cusno in $comp and orderhdr.orderdate>='$datefrom' and orderhdr.orderdate<='$dateto' and orderhdr.Owner_Comp='$owner_comp' " ;//12/20/2018 P.Pawan CTC add get shipto //25/11/2019 Zia added order progress
...
//Zia Added for Order Progress	> End
		...
		$odrsts=$aRow['ordtype'];
			...
			echo "<tr height=\"30\">";
			echo "<td width=\"8%\"  align=\"left\">".$corno."</td>";
			...
			echo "<td width=\"8%\"  align=\"right\">".number_format($slsqty,2)."</td>";
