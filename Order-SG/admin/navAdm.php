...
//start comment
// change for AWS Sep 2022
if($current=='mainCusRemAdm'){
//echo '<li id="current"><a href="mainCusRemAdm.php">Customer Remark</a></li>';
echo '<li id="current"><a href="mainCusRemAdm.php">Currency Code Setting</a></li>';
}else{
//echo '<li ><a href="mainCusRemAdm.php">Customer Remark</a></li>';
echo '<li ><a href="mainCusRemAdm.php">Currency Code Setting</a></li>'; 
}
//end comment
...
echo '<li id="current"><a href="cata_partcatalogue.php">Catalogue Maintenance</a></li>';
}else{
...
//Announcement
if($current=='ShipToInquery'){
echo '<li id="current"><a href="shiptomainAdm.php">Ship To Inquery</a></li>';
}else{
echo '<li><a href="shiptomainAdm.php">Ship To Inquery</a></li>';
}
...
if($current=='Leadtime'){
	echo '<li id="current"><a href="leadtime.php">Leadtime Setting</a></li>';
}else{
	echo '<li><a href="leadtime.php">Leadtime Setting</a></li>';
}
//End Comment
...
//start comment
// Add new menu for AWS Sep 2022
echo "<div class=\"headerbar2\">2 <sup class='lowercase'>nd</sup> CUSTOMER</div>";
echo "<ul>";
if($current=='awscusmas'){
	echo "<li id=\"current\"><a href=\"aws_cusmas.php\">2 <sup>nd</sup> Customer MA</a></li>";
}else{
	echo "<li><a href=\"aws_cusmas.php\">2 <sup>nd</sup> Customer MA</a></li>";
}
if($current=='aws_mainadm'){
	echo "<li id=\"current\"><a href=\"aws_mainadm.php\">2 <sup>nd</sup> Customer Sales Condition MA (DENSO)</a></li>";
}else{
	echo "<li><a href=\"aws_mainadm.php\">2 <sup>nd</sup> Customer Sales Condition MA (DENSO)</a></li>";
}
if($current=='aws_mainadm_nondenso'){
	echo "<li id=\"current\"><a href=\"aws_sup_mainadm.php\">2 <sup>nd</sup> Customer Sales Condition MA (NON-DENSO)</a></li>";
}else{
	echo "<li><a href=\"aws_sup_mainadm.php\">2 <sup>nd</sup> Customer Sales Condition MA (NON-DENSO)</a></li>";
}
if($current=='mainrptAdm'){
	echo "<li id=\"current\"><a href=\"aws_mainrptAdm.php\">2 <sup>nd</sup> Customer Detail Summary</a></li>";
}else{
	echo "<li><a href=\"aws_mainrptAdm.php\">2 <sup>nd</sup> Customer Detail Summary</a></li>";
}
echo '</ul>';
