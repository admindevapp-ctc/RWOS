...
$txtnote = trim($_GET['txtnote']);
 // ordno=202105020000001R&corno=PO210502A&orddate=02-05-2021&shipto=001&shipment=&action=new&ordertype=Request&requestDate=05-05-2021,09-05-2021,&txtnote=ทดสอบ&supno=20210401,23000333,
$vcusno = $cusno;
$vcusnm = $cusnm;
if($vordtype == "Request"){
    $ordtype = "R";
    ...
    if (!$hasil3) {
        if($vsupno != ""){
            ...
            for($i = 0; $i < count($array) -1; $i++)
            {
                ...
                $result = ctc_get_supordertemp_bysupno($shpCd, $array[$i],$imptable);
                ...
                foreach ($result as $r) {
                   // $show .= $r['PartNo'] .">". $vordno.">". $vcorno.">". $action.">" . $vshpno.">".$oecus.">". $vshipment.">". $r['qty'] .">". $vordtype .">Date:". $passDueDate.">".$r['supno'].">".$r['shipto'] ."<br/>";
