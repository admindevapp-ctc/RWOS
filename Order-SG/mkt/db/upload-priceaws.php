...
if(isset($_POST['submit'])){
    ...
    if($flagpro=='upcsv'){
        ...
        if (($handle = fopen($file, "r")) !== FALSE) {
            ...
            while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
                        ...
                        if(strlen($fcusno)!=0 && strlen($fitnbr)!=0 && strlen($fprice)!=0 && 
                            ...
                            if(strlen($fcusno)<=8 && strlen($fitnbr)<=15 && strlen($fprice)<=15 && 
                                strlen($fcurcd)==2 ){
                                    ...
                                    $sqs2="SELECT Cusno, CUST2, CUST3 FROM cusmas WHERE Cusno='$fcusno'";
                                    ...
                                    if($arrqs2){
                                        ...
                                        $sqs3="SELECT ITNBR FROM bm008pr WHERE ITNBR='$fitnbr'";
               ...
               if($status!='H'){
			   $qi="INSERT INTO sellpriceawstmp(Cusno, Itnbr,PriceAWS,CurCDAWS,Price,CurCD,DlrCD,
                    ...
                    ON DUPLICATE KEY UPDATE Cusno='$fcusno',Itnbr='$fitnbr',
                        PriceAws=$fprice,CurCDAWS='$fcurcd',Price=$fdprice,CurCD='$fdcurcd', DlrCD='$fdlrcd', StatusItem='$status',Keterangan='$msg'";
        ...
        $qs2="SELECT Cusno,Itnbr FROM sellpriceAwstmp WHERE StatusItem != 'H'";
        ...
        while($arr2=mysqli_fetch_array($sqlqs2)){
            ...
            $qs3="SELECT Cusno,Itnbr FROM sellpriceaws WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
            ...
            if(!$arr3){
                if($radvalact=='add'){
                    ...
                    $qu1="UPDATE sellpriceawstmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
                ...
                if($radvalact=='edit'){
                    ...
                    $qu2="UPDATE sellpriceawstmp SET StatusItem='$status', Keterangan='$msg' WHERE Cusno='$cusnotmp' AND Itnbr='$itnbrtmp'";
    ...
    //echo $msg;
    echo "<SCRIPT type=text/javascript>document.location.href='../imsalesaws.php?msg=$msg'</SCRIPT>";
}
?>
