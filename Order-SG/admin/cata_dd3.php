...
self.location='cata_partcatalogue.php?cat=' + val ;
}
...
self.location='cata_partcatalogue.php?cat=' + val + '&cat3=' + val2 ;
}
...
echo "<form method=post name=f1 id='orderdatefrom' action='cata_searchAdmin.php'>";
...
echo "<input type=submit value='Search' class='arial11'></form>";
?>
