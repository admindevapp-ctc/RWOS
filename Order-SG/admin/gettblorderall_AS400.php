...
header("Location:../login.php");
	...
	//total Row Count
	$sql = "SELECT * from orderhdr inner join orderdtl on orderhdr.orderno=orderdtl.orderno where  orderhdr.orderdate>='$datefrom' and orderhdr.orderdate<='$dateto'";
