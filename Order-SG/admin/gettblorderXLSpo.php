...
" where  orderdtl.orderdate>='$datefrom' and orderdtl.orderdate<='$dateto' and orderdtl.Owner_Comp='$comp' GROUP BY Corno, cusno, orderdate, orderno ORDER BY Corno, cusno, orderdate, orderno";
