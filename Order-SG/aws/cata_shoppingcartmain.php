        ...
        <script>
            ...
            $(document).ready(function () {
                            ...
                            if (data !== '') {
                                ...
                                if (bValid) {
                                    ...
                                    if (erShipto !== 0) {
                                        ...
                                        $.ajax({
                                            type: 'GET',
                                            url: 'cataloguemain/ctc_validate_order_ajax.php',
                                            data: edata,
                                            success: function (data) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
							...
							if(rcv[3] == '1'){
								...
								$("#requestDate").css("background-color", "#eee");
								alert(rcv[4])
							}
                ...
                table = $('#tablecatalog').removeAttr('width').DataTable({
                    ...
                    ajax: {
                        url: 'cataloguemain/ctc_get_shoppingcart_table_ajax.php',
                        dataType: 'json',
                        type: 'POST',
                        data: function (data) {
                        ...
                        complete: function (result) {
                            ...
                            $(".touchspinQuantity", tableRows).on('change', function () {
                               ...
                               // alert(numberCart);
                                ...
                                var amount = priceValue * numberCart;
                                ...
                                $(amountId, tableRows).html(amount);
                                UpdateTotalQuantity();
                ...
                function UpdateTotalAmount(currency) {
                    ...
                    if(parseInt(sumAmount)>0){
                        sumAmount = parseFloat(sumAmount).toFixed(2)
                    }
                    else{
                        sumAmount = "";
                    }
                    $('#total-amount').html(sumAmount + ' ' + currency);
