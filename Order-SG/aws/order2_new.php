        ...
        $(function() {
            ...
            $("#dialog-timeout").dialog({
                ...
                close: function() {
                    ...
                    jQuery('#cmdClose').click(function() {
                        window.location.href = "main.php?ordertype=Request";
                    });
                                ...
                                success: function(data) {
                                    ...
                                    if (data.substr(0, 5) == 'Error' || data.substr(0, 7) == 'ผิดพลาด') {
                                        ...
                                        return false;
											...
											var itdsc = xdata[0];
											var curcd = xdata[1];
											var bprice = xdata[2] == 'NULL' ? '': xdata[2];
											var ttlprice = xdata[3] == 'NULL' ? '': xdata[3];
											 ttlprice = ttlprice == '0.00' ? '': ttlprice;
											var ttlex = xdata[4];
											var duedt = xdata[5];
											if (ordertype == 'Request') {
												parts = $('#requestDate').val().split("-");
            ...
            $("#dialog-progress").dialog({ //CTC P.Pawan Add dialog show result email sent -- start --
                ...
                open: function(event, ui) {
                    $(".ui-dialog-titlebar-close", ui.dialog | ui).click(function() {
                        var url = "main.php?ordertype=Request";
            ...
            $("#cmdSave").click(function() {
                ...
                edata = "orderno=" + orderno + "&corno=" + corno + "&shpno=" + shpno + "&action=" + action 
                    + "&ordertype=" + ordertype + "&shpCd=" + shpCd + "&txtnote=" + txtnote; 
                //alert(edata);
...
$tmpEmail = [];
 $query = "
	select distinct mail_add1,mail_add2,mail_add3,prsn_mail_add1,prsn_mail_add2, prsn_mail_add3 ,comp_mail_add
	from awscusmas st 
		left join shiptoma on shiptoma.Owner_Comp = st.Owner_Comp and shiptoma.cusno = st.cusno1 and shiptoma.ship_to_cd = st.ship_to_cd1
	WHERE st.cusno2 = '$vcusno' AND st.ship_to_cd2 = '$shpCd' AND st.Owner_Comp = '$comp' AND st.cusno1 = '$dealer'
	";
...
while ($axData = mysqli_fetch_array($sql)) {
    ...
    $prsn_mail_add1 = $axData['prsn_mail_add1'];
    $prsn_mail_add2 = $axData['prsn_mail_add2'];
    $prsn_mail_add3 = $axData['prsn_mail_add3'];
    $prsnMail1 = $axData['mail_add1'];
    $prsnMail2 = $axData['mail_add2'];
    $prsnMail3 = $axData['mail_add3'];
}
array_push($tmpEmail, $comp_mail_add, $prsn_mail_add1, $prsn_mail_add2, $prsn_mail_add3, $prsnMail1, $prsnMail2, $prsnMail3);
    ...
    <div id="isi">
        <div id="twocolRight1">
            ...
            <table width="97%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table width="97%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                $query = "select ship_to_cd2 as ship_to_nm,ship_to_adrs1 adrs1 , ship_to_adrs2 adrs2
                                    ...
                                    from awscusmas
                                    where trim(ship_to_cd2) =trim('".$shpCd."') and trim(cusno2) = trim('".$cusno."') 
                                    and Owner_Comp='$comp'"; 
                                ...
                                while ($axQuery = mysqli_fetch_array($sqlResult)) {
                                    ...
                                    echo "<td width=\"5%\" class=\"arial11blackbold\" id=\"shipToAddress\">" . $adrs1 . "<br>" . $adrs2 . "<br>" . $adrs3. "</td>";
                                }
                ...
                <tr class="arial11blackbold">
                    <td><?php echo get_lng($_SESSION["lng"], "L0053"); ?><!--PO Number-->
                    </td>
                    <td>:</td>
            ...
            <p>&nbsp;</p>
            <table class="save_action" width="97%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
                <tr align="right">
                    <td width="10%" align="left"><input style="margin-right:5px;" type="button" value="<?php echo get_lng($_SESSION["lng"], "L0057");/*Save order Entry*/ ?>" id="cmdSave" class="arial11blackbold"></input></td>
                        ...
                        <div style="width: 463px;background-color: white;border-radius: 5px;height: 44px;">
                            ...
                            <div style="width:80%;">
                                <div style="float:left; text-align:center;">
                                    <div style="font-size: 12px;font-weight: 600;color: #ad1d36;"><?php echo get_lng($_SESSION["lng"], "L0568");/*Quantity*/ ?></div>
                ...
                <tbody>
					...
					?>
                        ...
                        <tr align="center" valign="middle" bgcolor="#990033" class="arial11whitebold">
                            ...
                            <!--Part Number-->
                            <th width="10%"><?php echo get_lng($_SESSION["lng"], "L0061"); ?></th>
                            <!--Qty-->
                    ...
                    <?php
                        ...
                        $query = "select a.* from  $awstable a where trim(a.cusno) ='" . $vshpno . "' and trim(a.orderno)='" . $xordno . "' and Owner_Comp='$comp' order by a.partno";
                        $sql = mysqli_query($msqlcon, $query);
                        ...
                        while ($hasil = mysqli_fetch_array($sql)) {
                           ...
                           // $vbprice = number_format($bprice, 2, ".", ",");
                            $vbprice = $bprice == '' ? '': number_format($bprice, 2, ".", ",");
                            $ttl = $vbprice == '' ? '': number_format($slsprice * $qty, 2, ".", ",");
