...
<body >
    ...
    <td colspan="3">
      <label> Sort by   : 
        <select name="sortby" id="sortby" class="arial11black"  style="width: 200px">
          <option value=""></option>
          <option value="PRTNO">Part Number</option>
          <option value="CUST3">Customer </option>
           <option value="RFQNO">RFQ Number</option>
          </select>
      </label>    </td>
    <td></td>
    <td colspan="3">
  ...
  <tr class="arial11blackbold">
    <td colspan="3">
     <label>
      <input type="text" name="srccust3" class="arial11black"  style="width: 200px">
    </label>
    </td>
    <td></td>
    <td colspan="3">
    <label>
      <input type="text" name="srcpart" class="arial11black"  style="width: 200px">
...
<?
	...
	if(isset($_GET["srcpart"])){
		$srcpart=$_GET["srcpart"];
		$srccust3=$_GET["srccust3"];
		
			if($srcpart!=""){
				$criteria=" where PRTNO like '" . $srcpart . "%'";		
				if($srccust3!=""){
				...
				if($srccust3!=""){
					$criteria=$criteria. " where CUST3 like '" . $srccust3 . "%'";		
				}else{
					$criteria="";
				}
			}
	...
	if($criteria==""){
		$criteria=" where STSMKT!='' and Owner_Comp='$comp' ";  // edit by CTC
	}else{
		$criteria= $criteria." and STSMKT!='' and Owner_Comp='$comp' ";  // edit by CTC
	}
	...
	$query1=$query . " LIMIT $start, $mper_page";
		...
		$sql=mysqli_query($msqlcon,$query1);		
			while($hasil = mysqli_fetch_array ($sql)){
				$owner_comp=$hasil['Owner_Comp'];  // add by CTC
				$cust3=$hasil['CUST3'];
				$rfqno=$hasil['RFQNO'];
				$RFQDT=$hasil['RFQDT'];
				$periode=$hasil['RFQYM'];
 	...
 	echo "<tr>";
    echo '<td colspan="'.$colnum.'" class="lasttd" align="right"><img src="../images/edit.png" width="20" height="20"><span class="arial11redbold"> = edit</span></td>';
	?>
    </tr> 
</table>
