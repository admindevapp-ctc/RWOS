        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                function UpdateMakerList() {
                    $.ajax({
                        url: "cataloguemain/ctcMktGetCalalogueCarmakerAjax.php",
                        type: 'post',
                ...
                function UpdateModelNameList() {
                    $.ajax({
                        url: "cataloguemain/ctcMktGetCalalogueModelNameAjax.php",
                        type: 'post',
                ...
                function UpdateModelCodeList() {
                    $.ajax({
                        url: "cataloguemain/ctcMktGetCalalogueModelCodeAjax.php",
                        type: 'post',
                ...
                function UpdateSubCategory() {
                    $.ajax({
                        url: "cataloguemain/ctcMktGetCalalogueSubCatagoryAjax.php",
                        type: 'post',
                        data: {
                ...
                function ReloadCarousel() {
                    $('#cartBadge').empty();
                    $.ajax({
                        url: "cataloguemain/ctcMktGetAnnounceAjax.php",
                        type: 'post',
                        success: function (response) {
                            var decodeJson = JSON.parse(response);
                ...
                function UpdateSideDetail(box) {
                    ...
                    if (currentSideBar !== edit_id +''+cusno) {
                        ...
                        $.ajax({
                            url: "_cata_cataloguemain_details_sidebar.php",
                            type: 'post',
                ...
                table = $('#tablecatalog').removeAttr('width').DataTable({
                    ...
                    ajax: {
                        url: 'cataloguemain/ctcMktGetCalalogueTableAjax.php',
                        dataType: "json",
                        type: "POST",
                        data: function (data) {
                        ...
                        complete: function (result) {
                            ...
                            $('.button-datail').on('click', function () {
                                ...
                                $.ajax({
                                    url: "_cata_cataloguemain_details_modal.php",
                                    type: 'post',
                                    data: {edit_id: edit_id, lotsize: lotSize,cusno :cusno},
                                    success: function (data) {
                                        console.log(data);
                    ...
                    'columnDefs': [
                        {"className": "text-center", "targets": [ 14, 15]},
                        {"className": "text-center toSide", "targets": [9,10]},
                        {"className": "text-center", "targets": [12,13]},
                        {"className": "text-center toSide", "targets": [ 1, 2, 3, 4, 5, 6,7,8,11]},
                        {"orderable": false, "targets": [3,4,5,12,13,14,15]},
                        {"className": "hidden", "targets": [0]},
                        {width: 60, targets: 0},//Id
            ...
            <div class="col-md-12 margin-bottom-md" style="padding-right: 40px;">
                <div class="row">
                    <div class="col-md-12 arial21redbold">
                        <img src="../../images/cata.png" width="17" height="15">&nbsp; <?php echo get_lng($_SESSION["lng"], "L0325")/* Find */; ?>
                    </div>
                </div> 
                <div class="row arial11blackbold margin-top-md">
