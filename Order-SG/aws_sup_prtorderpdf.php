...
{       
	...
	$sql = "SELECT *, supawsorderhdr.supno, supawsorderdtl.ordflg as flgorder  ".
		...
		" INNER JOIN awscusmas ON awscusmas.cusno2 = supawsorderhdr.CUST3 AND awscusmas.ship_to_cd2 = supawsorderhdr.shipto AND awscusmas.Owner_Comp = supawsorderhdr.Owner_Comp ".	
		" where supawsorderhdr.orderno='".$ordno. "' and supawsorderhdr.dealer='". $cusno. "' and supawsorderhdr.corno='".$corno. "' and supawsorderhdr.Owner_Comp='".$comp. "' and supawsorderhdr.supno='".$supno."' order by partno " ;  
	$sql;	  
	...
	$count = mysqli_num_rows($sumResult);
	$i="0";
	$grand_qty = 0;
	$grand_total = 0;
	$grand_total2 = 0;
...
//add by Pasakorn N.
			...
			$pdf->Cell(25,8, $statustext,1,1,C);
	...
	/*Zia Added to add note..start*/	
	  ...
	  $qrycusmas = "SELECT notes, supawsorderdtl.ordflg as flgorder from supawsorderhdr ".
		" inner join supawsorderdtl on supawsorderhdr.orderno=supawsorderdtl.orderno and supawsorderhdr.Owner_Comp=supawsorderdtl.Owner_Comp ".
		" inner join cusmas on supawsorderhdr.cusno=cusmas.cusno and supawsorderhdr.Owner_Comp=cusmas.Owner_Comp ".
		" inner join shiptoma on supawsorderhdr.shipto=shiptoma.ship_to_cd and supawsorderhdr.cusno=shiptoma.cusno and supawsorderhdr.Owner_Comp=shiptoma.Owner_Comp ".
		" inner join supordernts on supawsorderhdr.orderno=supordernts.orderno and supawsorderhdr.cusno=supordernts.cusno and supawsorderhdr.Owner_Comp=supordernts.Owner_Comp ".
		" where supawsorderhdr.orderno='".$ordno. "' and cusmas.Cust3='". $cusno. "' and supawsorderhdr.corno='".$corno. "' and supawsorderhdr.Owner_Comp='". $comp. "'  and supawsorderhdr.supno='".$supno."' order by partno ";
