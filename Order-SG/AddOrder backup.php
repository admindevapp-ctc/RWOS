...
$(function() {
 ...
 at: "center top",
			...
			buttons: {
				...
				var shpno=$('#shpno').val();
				edata="partno="+epartno +"&orderno="+orderno+"&qty="+quantity+"&corno="+corno+"&ordtype="+ordtype+"&shpno="+shpno+"&action="+vaction;
	 ...
	 $('#fileupload').fileupload({
		...
		//	 alert ('add');
             ...
             vOutput+="<tr><td width='300px'>"+filex.name+"</td>";
	     	 vOutput+="<td width='200px'><div id='progress'><div class='bar' id='"+filex.name +"' style='width: 0%;' ></div></div></td>";
			// alert(vOutput);
	     	 vOutput+="<td width='100px'><input type='button' class='fileUpload'  ></td>";
	...
	stop:function(e, data){
    	...
    	$.each(data.result.files, function (index, file) { 
			...
			//console.dir(slpgr);
			slpgr.parent().parent().parent().remove()
...
<?
  ...
  <tr class="arial11blackbold">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="5"><table id="resultTable"></table>
    </td>
