...
// mengisi pada cell A10 (baris ke-0, kolom ke-6)
xlsWriteLabel(0,13,"Ship Date"); // Zia Added for Order Progress

// mengisi pada cell A10 (baris ke-0, kolom ke-6)
xlsWriteLabel(0,14,"Ship Qty"); // Zia Added for Order Progress

// mengisi pada cell A10 (baris ke-0, kolom ke-6)
xlsWriteLabel(0,15,"Invoice NO"); // Zia Added for Order Progress

// mengisi pada cell A10 (baris ke-0, kolom ke-6)
xlsWriteLabel(0,16,"Status"); // Zia Added for Order Progress
...
//Zia Added for Order Progress	> End
	...
	// menampilkan no. urut data
		...
		xlsWriteLabel($noBarisCell,1,$shpto);
		xlsWriteLabel($noBarisCell,2,$shptonm);
...
// menampilkan data nim
		...
		xlsWriteNumber($noBarisCell,11,$total);
		//xlsWriteNumber($noBarisCell,10,$totalsg);
 	 	xlsWriteLabel($noBarisCell,12,$duedt);
 	 	xlsWriteLabel($noBarisCell,13,$shpdate);  // Zia Added for Order Progress
 	 	xlsWriteLabel($noBarisCell,14,$slsqty);	  // Zia Added for Order Progress
		xlsWriteLabel($noBarisCell,15,$invno);  // Zia Added for Order Progress	
 	 	xlsWriteLabel($noBarisCell,16,$ordrflg);  // Zia Added for Order Progress	         		
		$noBarisCell++;
