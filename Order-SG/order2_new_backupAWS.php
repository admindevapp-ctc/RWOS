										...
										if($('#hid_chk_tf').val() == '1'){
											...
											if (vaction == 'add') {
												$('#myTable > tbody:last').append("<tr>" +
													...
													"<td class=\"price\" align=\"right\">" + discratio + "</td>" +
													"<td class=\"price\" align=\"right\">" + acsale + "</td>" +
                ...
                <tbody>
                    ...
                    ?>
                        <tr align="center" valign="middle" bgcolor="#990033" class="arial11whitebold">
                            ...
                            <th width="12%"><?php echo 'Actual Sales Price' ?>
                                <!--Actual Sales Price-->
                            </th>
                    ...
                    if ($chk_tf) {
                        ...
                        while ($hasil = mysqli_fetch_array($sql)) {
                            ...
                            echo "<td class=\"price\" align=\"right\">" . number_format($lbprice, 2, ".", ",") . "</td>";
                            echo "<td class=\"disc\" align=\"right\">" . number_format($disc_ratio, 2, ".", ",") . "</td>";
                            echo "<td class=\"price\" align=\"right\">" . number_format($ac_slsprice, 2, ".", ",") . "</td>";
