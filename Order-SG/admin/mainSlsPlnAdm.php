...
$('#ConvExcel').click(function(){
  ...
  <tr class="arial11white" bgcolor="#AD1D36" >
  	<th width="15%" scope="col">Company Code</th>
	...
	$query="select * from slsplan where Owner_Comp='$comp'";
	...
	$query1="select * from slsplan where Owner_Comp='$comp' order by PROD, SUBPROD".		
	...
	$sql=mysqli_query($msqlcon,$query1);	
		...
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vcomp."</td><td>".$vprod."</td><td>".$vsubprod."</td><td>".$vcust3."</td><td>".$vyyyymm."</td><td>".$vqty."</td><td>".$vamount."</td>" ;
