...
<html>
    <head>
        ...
        //CTC P.Pawan 04/03/19 Add dialog messege -- start --
            ...
            function sendEmail(orderNo,shipToCd,corNo){//CTC P.Pawan 04/03/19 prepare send email -- start --
              $(".axEmail").each(function(){
                this.value = "";
              });
        ...
        <div id="twocolRight">
                ...
                <tr class="arial11blackbold">
                    ...
                    <td>
                        <select name="ordertype" id="ordertype" style="width: 300px; font-size:11px" class="arialgrey">
                            <option value="All" <?php if ($ordertype == 'All') { ?> selected <?php }; ?>><?php echo get_lng($_SESSION["lng"], "L0301"); ?><!--All--></option>
                            <option value="N" <?php if ($ordertype == 'N') { ?> selected <?php }; ?>><?php echo get_lng($_SESSION["lng"], "L0118"); ?><!--Normal Order--></option>
                            <option value="R" <?php if ($ordertype == 'R') { ?> selected <?php }; ?>><?php echo get_lng($_SESSION["lng"], "L0119"); ?><!--Request Due Date--></option>
                            <option value="U" <?php if ($ordertype == 'U') { ?> selected <?php }; ?>><?php echo get_lng($_SESSION["lng"], "L0120"); ?><!--Urgent Order--></option>
                            <!-- <option value="A" <?php //if ($ordertype == 'A') { ?> selected <?php// }; ?>><?php// echo get_lng($_SESSION["lng"], "L0121"); ?><!--Advance Order--></option> -->
                        </select>
                    </td>
                    <td colspan='4'></td>
                </tr>
            ...
            <table width="100%" class="tbl1" cellspacing="0" cellpadding="0">
                ...
                if ($ordertype == 'A' || $ordertype == 'U' || $ordertype == 'R' || $ordertype == 'N') {
                    $query = "select * from orderhdr  where Trflg!='' and Cust3 ='" . $cusno . "' and ordtype='$ordertype' and Owner_Comp='$owner_comp' order by orderdate desc";
                } else {
                    $query = "select * from orderhdr  where Trflg!='' and Cust3 ='" . $cusno . "' and Owner_Comp='$owner_comp' order by orderdate desc";
                }
                ...
                while ($hasil = mysqli_fetch_array($sql)) {
                    ...
                    if ($orderstatus == "R") {
                        ...
                        $urlprint = "<a href='prtaddorderpdf.php?ordno=" . $ordno . "&corno=" . $corno . "' target=\"new\"> <img src=\"images/print.png\" width=\"20\" height=\"20\" border=\"0\"></a>";
                    }
