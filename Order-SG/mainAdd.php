...
$(function() {
	...
	var corno = $( "#txtCorno" ),
		...
		$( "#dialog-form" ).dialog({
			...
			buttons: {
				...
				var vaction="newAdd";
				edata="ordno="+vorderno+"&corno="+vcorno+"&ordtype="+vordertype+"&orddate="+vorddate+"&shpno="+vshpno+"&shipment="+vshipment+"&action="+vaction;
				//alert(edata);
  ...
  <tr class="arial11blackbold">
    ...
    <td>:</td>
    <td  class="arial11blackbold"><select name="OptOrderType" id="OptOrderType" class="arial11blackbold" style="width: 100px" disabled >
  ...
  <tr class="arial11blackbold">
    ...
    <td>:</td>
    <td colspan="5"><?
	$qryshp="SELECT cusmas.Cusno,cusmas.OECus, cusrem.curcd, cusrem.remark FROM `cusmas` INNER JOIN cusrem ON cusmas.cusno = cusrem.cusno where  trim(cust3) ='".$cusno. "' order by cusno" ;
	//echo $qryshp;
