...
<tr>
<td width="50%" class="arial21redbold"><strong style="font-size: 30px;"><?php echo get_lng($_SESSION["lng"], "L0326"); ?></strong></td> <!--Announcement -->
...
<table cellpadding="0" cellspacing="0" border="0"  width="100%">
  ...
  <tr class="arial11blackbold">
		<td width="2%">&nbsp;</td>
		<td width="17%"><strong><?php echo get_lng($_SESSION["lng"], "L0327"); ?></strong></td> <!--Title -->
		<td width="1%">:</td>
  ...
  <tr class="arial11blackbold">
		<td>&nbsp;</td>
		<td><?php echo get_lng($_SESSION["lng"], "L0328"); ?></td> <!--Detail -->
		<td>:</td>
  ...
  <tr class="arial11blackbold">
		<td>&nbsp;</td>
		<td><?php echo get_lng($_SESSION["lng"], "L0329"); ?><!--New Password--></td><!--Start Date -->
		<td>:</td>
  ...
  <tr class="arial11blackbold">
		<td>&nbsp;</td>
		<td><?php echo get_lng($_SESSION["lng"], "L0330"); ?></td> <!--End Date -->
		<td>:</td>
  ...
  -->
  	<tr class="arial11blackbold">
		<td>&nbsp;</td>
		<td><?php echo get_lng($_SESSION["lng"], "L0332"); ?></td> <!--Update Date-->
		<td>:</td>
