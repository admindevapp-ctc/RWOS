...
if ($error) {
    ...
    //$query="select * from supprice where partno = '$partno' and Cusno= '$shpno' and Owner_Comp='$comp' and shipto='$shpCd' ";
     ...
     $query="select supcatalogue.*, supawsexc.price, supawsexc.curr
     from (
         SELECT *
         FROM  awscusmas  
         WHERE cusno2 = '$shpno' and Owner_Comp = '$comp' and ship_to_cd2 = '$shpCd'
     ) a
     ...
     where supcatalogue.Prtno ='$partno' 
     ";
			...
			if($lot == null || $lot == 0){
				...
				if($sisa==0){
					...
					*/
					...
					$desc=$partdes."||".$curcd."||".$slsprice."||".$vttlprice."||1||".$duedate_format2."||".$supno."||".$supnm;	
					// Check in tmp table
