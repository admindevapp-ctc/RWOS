...
function checkLengthmax( o, n, min, max ) {
  ...
  <tr class="arial11grey" bgcolor="#AD1D36" >
	...
	$query="select * from specialpriceAws";
	...
	$query1="select * from specialpriceAws   order by cusno, itnbr".		
	...
	$sql=mysqli_query($msqlcon,$query1);	
		...
		echo "<tr class=\"arial11black\" align=\"center\" height=\"30\"><td>".$vcusno."</td><td>".$vitnbr."</td><td>".$vcurcd."</td><td>".$vprice."</td><td>".$dcurcd."</td><td>".$dprice."</td><td>".$vcust3."</td>" ;
