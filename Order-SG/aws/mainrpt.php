...
$(document).ready(function() {
  ...
  <tr class="arial11blackbold">
	...
	<table width="224" border="0">
      <tr>
        <td width="105"><input name="orderdatefrom" id="orderdatefrom" placeholder="dd/mm/yyyy" type="text" size="12" maxlength="12" autocomplete="off"></td>
        <td width="12">&nbsp;</td>
        <td width="93">
  ...
  <tr class="arial11blackbold">
	...
	<table width="224" border="0">
      <tr>
        <td width="105"><input name="orderdateto" id="orderdateto" placeholder="dd/mm/yyyy" type="text" size="12" maxlength="12" autocomplete="off"></td>
        <td width="12">&nbsp;</td>
        <td width="93">
  ...
  <tr valign="middle" class="arial11" height="30">
    ...
    <th colspan="1" scope="col" align="right">
...
<table cellpadding="0" cellspacing="0" border="0" class="tbl1" id="example" width="97%">
	<thead >
		...
		<tr align="center" height="30" >
				<!--	<th width="5%"><?php //echo get_lng($_SESSION["lng"], "L0218"); ?></th><!--Ship To-->

            <th width="8% "><div id="Partno"><div class="PartAsc"><a href="#" ><?php echo get_lng($_SESSION["lng"], "L0215"); ?><!--Part Number--></a></div></div></th>
            <th width="13%"><?php echo get_lng($_SESSION["lng"], "L0216"); ?><!--Part Name--></th>
			<th width="8% "><div id="Pono"><div class="PartAsc"><a href="#" ><?php echo get_lng($_SESSION["lng"], "L0217"); ?><!--PO Number--></a></div></div></th>
			<th width="8% "><div id="odrdate"><div class="PartAsc"><a href="#" ><?php echo get_lng($_SESSION["lng"], "L0219"); ?><!--Order Date--></a></div></div></th>
            <th width="8% "><?php echo get_lng($_SESSION["lng"], "L0220"); ?><!--Due Date--></th>
			<th width="3% " ><?php echo get_lng($_SESSION["lng"], "L0221"); ?><!--Qty--></th>
			<th width="8% " ><?php echo get_lng($_SESSION["lng"], "L0569"); ?><!--Amount--></th>
			<th width="10% " ><?php echo get_lng($_SESSION["lng"], "L0564"); ?><!--Order Approve Status--></th>
			<th width="8% " ><?php echo get_lng($_SESSION["lng"], "L0556"); ?><!--Ship Date--></th>
			<th width="8% " ><?php echo get_lng($_SESSION["lng"], "L0557"); ?><!--Ship Qty--></th>
			<th width="8% " ><?php echo get_lng($_SESSION["lng"], "L0558"); ?><!--Invoice No--></th>
			<th width="8% " class="lastth"><?php echo get_lng($_SESSION["lng"], "L0559"); ?><!--Status--></th>
		</tr>
	</thead>
	<tbody>
		<tr>
...
<div id="loading" style="display:none;" align="center"><img src="../images/35.gif" width="64" height="64" /></div>
        ...
        <div id="dialog-form" title="<?php echo get_lng($_SESSION["lng"], "L0213");/*Search*/ ?>"  style="display: none;" >
		  ...
		  <select name="field" id="OptField" class="arial11blackbold" style="width: 100px">
        	<option value="" ></option>
	       	<option value="partno" ><?php echo get_lng($_SESSION["lng"], "L0215");/* Part Number*/ ?></option>
        	<option value="ITDSC"><?php echo get_lng($_SESSION["lng"], "L0216")/*Part Name*/; ?></option>
            ...
            <option value="invoice"><?php echo get_lng($_SESSION["lng"], "L0558"); ?></option>
            <option value="status"><?php echo get_lng($_SESSION["lng"], "L0559"); ?></option>
        </select>
