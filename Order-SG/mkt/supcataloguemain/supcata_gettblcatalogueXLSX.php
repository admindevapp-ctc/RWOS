...
,'Genuine Part No.','Supplier Code','Supplier Genuine Part No.','Part Name','Picture Name','Product Brand'
,'Order Part No.', 'Standard Price', 'Lot Size', 'Stock', 'Stock/Non Stock Item','Remark'];
...
foreach ($result as $aRow) {
    ...
    $data= [$CarMkr,$MdlName,$VinCode,$MdlCode,$EngCode,$cc,$strdate,$enddate
    ,$Cptn,$supcd ,$dnPrt,$Prtnam,$prtpic,$BrandName
    ,$Ordprt,$stdprice,$lotsize,$stock,$mto,$Remrk];
