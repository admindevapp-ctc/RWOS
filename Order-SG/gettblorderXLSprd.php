...
" where orderdtl.cust3='$cusno' and orderdtl.orderdate>='$datefrom' and orderdtl.orderdate<='$dateto'  and orderdtl.Owner_Comp='$owner_comp'  GROUP BY Product, subprod, orderdate, corno ORDER BY Product, subprod, orderdate, corno";
