...
require('../db/conn.inc');
$query="select * from userid where trim(cusno) = '$supno' and Owner_Comp='$owner_comp' ";
...
if ($error) {
	...
	$newpwd=trim($_POST['NewPassword']);  
	 ...
	 $query="update userid set Password='$newpwd' where trim(cusno) = '$supno' and Owner_Comp='$owner_comp' ";
