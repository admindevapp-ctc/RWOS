...
<body>
        ...
        <div id="twocolRight">
        	 <h3>AWS Price</h3>
             Download format excel here : <a href="prototype/SellPriceAws.xls" target="_blank" ><img src="../images/excel.jpg" width="16" height="16" border="0"></a>	
             <form method="POST" enctype="multipart/form-data" name="uploadForm" action="db/upload-priceaws.php">
            ...
            <?
			   ...
			   $msg=$_GET['msg'];
                ...
                if($msg=='Error'){
                    ...
                    $qse="SELECT * FROM sellpriceawstmp WHERE StatusItem='E' AND Owner_Comp='$comp'";
					//echo $qse;
                    ...
                    $msgtbl.="</table>";
                    $qd="DELETE FROM sellpriceawstmp where Owner_Comp='$comp'";
                ...
                if($msg=='Add'){
                    ...
                    $qi2="INSERT INTO sellpriceAws";
					$qi2.=" SELECT Owner_Comp,Cusno, Itnbr,PriceAWS,CurCDAWS,Price,CurCD,DlrCD FROM sellpriceawstmp WHERE StatusItem !='H' AND Owner_Comp='$comp'";
                ...
                if($msg=='Replace'){
                    $msgsuccess='Replace data success';
                     $qu3="SELECT Owner_Comp,Cusno, Itnbr,PriceAWS,CurCDAWS,Price,CurCD,DlrCD FROM sellpriceawstmp WHERE StatusItem !='H' AND Owner_Comp='$comp'";
                ...
                if($msg=='Confirm'){
                    // Check count 
                    $qc1="SELECT COUNT(*) AS fcount FROM sellpriceaws WHERE Owner_Comp='$comp'";
                    $sqlqc1=mysqli_query($msqlcon,$qc1);
                    $arqc1=mysqli_fetch_array($sqlqc1);
                    $fcount=$arqc1['fcount'];
                        
                    $qc2="SELECT COUNT(*) AS tmpcount FROM sellpriceawstmp WHERE StatusItem!='H' AND Owner_Comp='$comp'";
                    ...
                    ?>
                        <form method="POST" enctype="multipart/form-data" action="db/replace-all-priceaws.php">
                    ...
                    <?
                        $qa2="SELECT Cusno, Itnbr,PriceAWS,CurCDAWS,Price,CurCD,DlrCD FROM sellpriceawstmp WHERE StatusItem!='H' AND Owner_Comp='$comp' LIMIT 10";
